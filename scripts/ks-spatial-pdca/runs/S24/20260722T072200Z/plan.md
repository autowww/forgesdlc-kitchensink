# S24 — Cube gallery photo mode

**Kind:** upgrade · **Hash:** `Cbg` · **Depends on:** S14
...
- `docs/design/spatial/oracles/Cbg.json`
- `generator/spatial_wave2_showcase.py`

## Acceptance criteria

- v2 mode live at `spatial-rails.html#sec-cube-gallery-photo`
- Oracle scenario documents wave2 variant on `Cbg`
- `./scripts/ks-spatial-pdca/check-phase-gate.sh S24` passes

## Test plan

1. `python3 generator/build-showcase.py`
2. `./scripts/ks-spatial-pdca/check-phase-gate.sh S24`
