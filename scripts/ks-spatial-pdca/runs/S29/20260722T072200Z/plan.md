...
- v2 mode live at `spatial-surfaces.html#sec-iso-keypad`
- Oracle scenario documents wave2 variant on `Iso`
- `./scripts/ks-spatial-pdca/check-phase-gate.sh S29` passes

## Test plan

1. `python3 generator/build-showcase.py`
2. `./scripts/ks-spatial-pdca/check-phase-gate.sh S29`
