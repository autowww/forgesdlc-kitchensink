# S26 — Flip card stack variant

**Kind:** upgrade · **Hash:** `Flp` · **Depends on:** S03
...
- `docs/design/spatial/oracles/Flp.json`
- `generator/spatial_wave2_showcase.py`

## Acceptance criteria

- v2 mode live at `spatial-surfaces.html#sec-flip-stack`
- Oracle scenario documents wave2 variant on `Flp`
- `./scripts/ks-spatial-pdca/check-phase-gate.sh S26` passes

## Test plan

1. `python3 generator/build-showcase.py`
2. `./scripts/ks-spatial-pdca/check-phase-gate.sh S26`
