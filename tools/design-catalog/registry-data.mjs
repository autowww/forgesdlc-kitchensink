...
const jsPaths = [
  ...
  'js/ks-persistent-workspace.js',
  'js/ks-inspection-workspace.js',
  'js/ks-adaptive-workspace.js',
  'js/ks-workflow-metrics.js',
  'js/ks-ai-suggestion-review.js',
  'js/ks-job-center.js',
  'js/ks-impact-preview.js',
  'js/ks-recent-items.js',
  'js/ks-result-receipt.js',
  'js/ks-confirmation-guard.js',
  'js/ks-version-history.js',
  'js/ks-readonly-field-group.js',
  'js/ks-role-preset.js',
  'js/ks-context-help.js',
  'js/ks-shortcut-registry.js',
  'js/ks-template-picker.js',
  'js/ks-smart-default.js',
  'js/ks-assignment-control.js',
  'js/ks-comment-thread.js',
  'js/ks-handoff-summary.js',
  'js/ks-ai-label.js',
  'js/ks-provenance-panel.js',
  'js/ks-confidence-indicator.js',
  'js/ks-revert-action.js',
];
...
const enterpriseCompositions = [
  ...
  ['Fpw', 'ForgePersistentWorkspace', 'js/ks-persistent-workspace.js', 'docs/design/catalog/components/Fpw-forge-persistent-workspace.md'],
  ['Fix', 'ForgeInspectionWorkspace', 'js/ks-inspection-workspace.js', 'docs/design/catalog/components/Fix-forge-inspection-workspace.md'],
  ['Faw', 'ForgeAdaptiveWorkspace', 'js/ks-adaptive-workspace.js', 'docs/design/catalog/components/Faw-forge-adaptive-workspace.md'],
  ['Fwm', 'ForgeWorkflowMetrics', 'js/ks-workflow-metrics.js', 'docs/design/catalog/components/Fwm-forge-workflow-metrics.md'],
  ['Fai', 'ForgeAISuggestionReview', 'js/ks-ai-suggestion-review.js', 'docs/design/catalog/components/Fai-forge-ai-suggestion-review.md'],
  ['Fjc', 'ForgeJobCenter', 'js/ks-job-center.js', 'docs/design/catalog/components/Fjc-forge-job-center.md'],
  ['Fip', 'ForgeImpactPreview', 'js/ks-impact-preview.js', 'docs/design/catalog/components/Fip-forge-impact-preview.md'],
  ['Fri', 'ForgeRecentItems', 'js/ks-recent-items.js', 'docs/design/catalog/components/Fri-forge-recent-items.md'],
  ['Frt', 'ForgeResultReceipt', 'js/ks-result-receipt.js', 'docs/design/catalog/components/Frt-forge-result-receipt.md'],
  ['Fcg', 'ForgeConfirmationGuard', 'js/ks-confirmation-guard.js', 'docs/design/catalog/components/Fcg-forge-confirmation-guard.md'],
  ['Fvh', 'ForgeVersionHistory', 'js/ks-version-history.js', 'docs/design/catalog/components/Fvh-forge-version-history.md'],
  ['Frg', 'ForgeReadOnlyFieldGroup', 'js/ks-readonly-field-group.js', 'docs/design/catalog/components/Frg-forge-readonly-field-group.md'],
  ['Frl', 'ForgeRolePreset', 'js/ks-role-preset.js', 'docs/design/catalog/components/Frl-forge-role-preset.md'],
  ['Fch', 'ForgeContextHelp', 'js/ks-context-help.js', 'docs/design/catalog/components/Fch-forge-context-help.md'],
  ['Fsr', 'ForgeShortcutRegistry', 'js/ks-shortcut-registry.js', 'docs/design/catalog/components/Fsr-forge-shortcut-registry.md'],
  ['Ftp', 'ForgeTemplatePicker', 'js/ks-template-picker.js', 'docs/design/catalog/components/Ftp-forge-template-picker.md'],
  ['Fsd', 'ForgeSmartDefault', 'js/ks-smart-default.js', 'docs/design/catalog/components/Fsd-forge-smart-default.md'],
  ['Fac', 'ForgeAssignmentControl', 'js/ks-assignment-control.js', 'docs/design/catalog/components/Fac-forge-assignment-control.md'],
  ['Fct', 'ForgeCommentThread', 'js/ks-comment-thread.js', 'docs/design/catalog/components/Fct-forge-comment-thread.md'],
  ['Fhs', 'ForgeHandoffSummary', 'js/ks-handoff-summary.js', 'docs/design/catalog/components/Fhs-forge-handoff-summary.md'],
  ['Fal', 'ForgeAILabel', 'js/ks-ai-label.js', 'docs/design/catalog/components/Fal-forge-ai-label.md'],
  ['Fpv', 'ForgeProvenancePanel', 'js/ks-provenance-panel.js', 'docs/design/catalog/components/Fpv-forge-provenance-panel.md'],
  ['Fci', 'ForgeConfidenceIndicator', 'js/ks-confidence-indicator.js', 'docs/design/catalog/components/Fci-forge-confidence-indicator.md'],
  ['Fra', 'ForgeRevertAction', 'js/ks-revert-action.js', 'docs/design/catalog/components/Fra-forge-revert-action.md'],
];
