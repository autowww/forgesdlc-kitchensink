 ...
 */
export async function runReactKsAttrsFixer(ctx) {
  ...
  if (touched > 0) {
    return { applied: true, filesTouched: touched, adapter: 'react_ks_attrs_source' };
  }
  ...
  return { applied: false, error: 'no DET.REACT.KS_ATTRS findings' };
}
