...
const src = join(
  root,
  "tools/website-ux-auditor/docs/design/ux-audit/rule-pages/det-catalog-contract-specificity.md",
);
const dest = join(
  root,
...
console.log(
  JSON.stringify({
    canonical_exists: existsSync(dest),
    tools_exists: existsSync(src),
