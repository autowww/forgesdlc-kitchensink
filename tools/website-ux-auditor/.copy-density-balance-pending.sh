...
SRC="$ROOT/tools/website-ux-auditor/docs/design/ux-audit/rule-pages/ai-app-density-balance.md"
DEST="$ROOT/docs/design/ux-audit/rule-pages/ai-app-density-balance.md"
...
const r=j.rules.find(x=>x.id==='AI.APP.DENSITY_BALANCE');
