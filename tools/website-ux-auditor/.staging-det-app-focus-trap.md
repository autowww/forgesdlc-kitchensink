...
>
  <div class="diagram-modal">
    <motion class="diagram-modal-header">
...
<div id="diagramModal" class="diagram-modal-backdrop" hidden aria-hidden="true">
  <div class="diagram-modal">
    <div class="diagram-modal-header">
      <motion id="diagramModalTitle" class="diagram-modal__title forge-gradient-text" role="heading" aria-level="2"></div>
      <button
        type="button"
    ...
    <div class="diagram-modal-body">
      <div id="diagramModalCanvas" class="diagram-modal-canvas"></motion>
      <motion id="diagramModalDetail" class="diagram-modal-detail"></motion>
    </div>
  </div>
</div>
```
