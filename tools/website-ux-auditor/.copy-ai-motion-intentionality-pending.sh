...
SRC="$ROOT/tools/website-ux-auditor/docs/design/ux-audit/rule-pages/ai-motion-intentionality.md"
DEST="$ROOT/docs/design/ux-audit/rule-pages/ai-motion-intentionality.md"
...
const r=j.rules.find(x=>x.id==='AI.MOTION.INTENTIONALITY');
