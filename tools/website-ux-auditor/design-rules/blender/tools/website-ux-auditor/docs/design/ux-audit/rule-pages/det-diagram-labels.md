...
page_version: cdd10658d7e98dc2a71806809d720e73b9638f91949a17aa43c081cca3179a7f
...
Failing KS markup: catalog key `linear` with inline SVG whose visible text is only bracket placeholders (`diagram-labels-no-readable-text`). Second tile uses key `gate` but surface text abbreviates gates to **G** while the catalog expects **Gate 1** / **Gate 2** (`diagram-labels-legend-gap`).
...
<div class="ks-section" hash="Dgm" data-ks-hash="Dgm" data-ks-type="page" data-ks-name="diagrams">
  ...
  >
    <div class="ks-diagram-canvas">
      <svg viewBox="0 0 680 120" role="img" aria-label="Linear flow with placeholder steps only">
        <rect width="100%" height="100%" fill="#111827"/>
        <text x="340" y="16" text-anchor="middle" fill="#06B6D4" font-size="12">[Title  -  linear process]</text>
        <text x="84" y="70" text-anchor="middle" fill="#F1F5F9" font-size="9">[subtitle]</text>
        <text x="224" y="70" text-anchor="middle" fill="#F1F5F9" font-size="9">[subtitle]</text>
        <text x="364" y="70" text-anchor="middle" fill="#F1F5F9" font-size="9">[subtitle]</text>
        <text x="504" y="70" text-anchor="middle" fill="#F1F5F9" font-size="9">[subtitle]</text>
      </svg>
    </div>
...
Passing KS markup: `linear` tile uses registered `template-linear-flow.svg` (catalog node strings on the surface); `gate` tile spells out full gate names in readable `<text>` nodes.
...
<div class="ks-section" hash="Dgm" data-ks-hash="Dgm" data-ks-type="page" data-ks-name="diagrams">
  ...
  >
    <div class="ks-diagram-canvas">
      <svg viewBox="0 0 700 280" role="img" aria-label="Gate chain: Stage 1, Gate 1, Stage 2, Gate 2, Stage 3">
        <rect width="100%" height="100%" fill="#111827"/>
        <text x="70" y="52" text-anchor="middle" fill="#F1F5F9" font-size="11">Stage 1</text>
        <text x="196" y="58" text-anchor="middle" fill="#F59E0B" font-size="10">Gate 1</text>
        <text x="300" y="52" text-anchor="middle" fill="#F1F5F9" font-size="11">Stage 2</text>
        <text x="426" y="58" text-anchor="middle" fill="#F59E0B" font-size="10">Gate 2</text>
        <text x="530" y="52" text-anchor="middle" fill="#F1F5F9" font-size="11">Stage 3</text>
      </svg>
    </div>
    <p class="forge-support small mt-2 mb-0">
