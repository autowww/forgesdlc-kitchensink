...
page_version: 4db822e03feca4d2b56b94410012a653e3ca08a7ad5e72cae9d02d813b382d39
generated_at: 2026-05-28T17:02:00.000Z
...
- **Stock metaphor soup:** unlabeled icon grids, repeated `template-kpi-card.svg` tiles, or ambient `assets/svg/ambient/mesh-bloom.svg` with no mapping to product nouns on the page.
...
Failing KS markup: headline claims governed delivery, but the hero visual is decorative spectral art with empty `alt`; outcome cards reuse the same generic KPI template with no product mapping.
    ...
    <div class="row g-3">
      <div class="col-md-4">
        <div class="forge-card breathe-static p-3 h-100 text-center">
          <img src="assets/svg/template-kpi-card.svg" alt="" class="mb-2" width="48" height="48" />
      ...
      <div class="col-md-4">
        <a class="forge-card card-amber breathe-link h-100" href="/trust#human-control">
          ...
          <p class="forge-support mb-0">
            Gates in the diagram match operator-owned approval points—not a generic KPI tile.
          </p>
        </a>
      </div>
      <div class="col-md-4">
...
- `AI.VISUAL.HIERARCHY` — explanatory visuals should support the focal path, not compete with equal-weight filler.
