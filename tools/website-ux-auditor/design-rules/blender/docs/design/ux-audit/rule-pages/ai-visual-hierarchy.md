...
page_version: 1c2dfd692b0a56a69be869ad3de96abf48cf5c4aacc00aaa86f1a4fc2931eef1
...
7. If the same equal-weight defect repeats, record a `candidateDeterministicRule` (for example accent-role count per row) with stable DOM selectors for blender promotion.
...
- `AI.VISUAL.RHYTHM_SUBJECTIVE` — spacing and grouping rhythm; flat equal bands often fail both rhythm and hierarchy.
