...
page_version: 0aca28e5318ec24c5777c700f2920cc3781d6669a243a815bf4d69e96c16cf74
...
- **Severity:** **minor** for placeholder markers and stub bullets in default UX audit mode; stub bullets may surface as **warn** when mapped from catalog warnings in some pipelines.
      ...
      >
        <ol class="breadcrumb mb-1" style="font-size:0.75rem">
          <li class="breadcrumb-item">
            <a href="/showcase/index.html" class="text-cyan" style="text-decoration:none">Showcase</a>
          </li>
          <li class="breadcrumb-item">
            <a href="/showcase/layouts.html" class="text-cyan" style="text-decoration:none">Layouts</a>
          </li>
...
- `DET.INVENTORY.CROSSWALK` — showcase-emitted hashes must stay aligned with the registry after contract-driven HTML changes.
