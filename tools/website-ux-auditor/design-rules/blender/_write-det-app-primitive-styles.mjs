#!/usr/bin/env node
/** Copy staged DET.APP.PRIMITIVE_STYLES handbook page to KS docs (no manifest write). */
import fs from 'node:fs/promises';
import path from 'node:path';
import { fileURLToPath } from 'node:url';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const src = path.resolve(__dirname, 'docs/design/ux-audit/rule-pages/det-app-primitive-styles.md');
const dest = path.resolve(__dirname, '../../../../docs/design/ux-audit/rule-pages/det-app-primitive-styles.md');
const auditorCopy = path.resolve(__dirname, '../../docs/design/ux-audit/rule-pages/det-app-primitive-styles.md');
