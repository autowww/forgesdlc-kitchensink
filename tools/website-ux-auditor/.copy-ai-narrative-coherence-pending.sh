...
SRC="$ROOT/tools/website-ux-auditor/docs/design/ux-audit/rule-pages/ai-narrative-coherence.md"
DEST="$ROOT/docs/design/ux-audit/rule-pages/ai-narrative-coherence.md"
...
const r=j.rules.find(x=>x.id==='AI.NARRATIVE.COHERENCE');
