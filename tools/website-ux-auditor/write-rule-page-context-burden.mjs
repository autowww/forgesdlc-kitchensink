...
const src = path.join(__dirname, 'docs/design/ux-audit/rule-pages/ai-context-burden-subjective.md');
const dest = path.join(ksRoot, 'docs/design/ux-audit/rule-pages/ai-context-burden-subjective.md');
...
const row = manifest.rules.find((r) => r.id === 'AI.CONTEXT.BURDEN_SUBJECTIVE');
