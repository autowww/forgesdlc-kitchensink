...
SRC="$ROOT/tools/website-ux-auditor/docs/design/ux-audit/rule-pages/det-ambient-z-index.md"
DEST="$ROOT/docs/design/ux-audit/rule-pages/det-ambient-z-index.md"
...
const r=j.rules.find(x=>x.id==='DET.AMBIENT.Z_INDEX');
