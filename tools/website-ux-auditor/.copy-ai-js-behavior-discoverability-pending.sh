...
SRC="$ROOT/tools/website-ux-auditor/docs/design/ux-audit/rule-pages/ai-js-behavior-discoverability.md"
DEST="$ROOT/docs/design/ux-audit/rule-pages/ai-js-behavior-discoverability.md"
...
const r=j.rules.find(x=>x.id==='AI.JS.BEHAVIOR_DISCOVERABILITY');
