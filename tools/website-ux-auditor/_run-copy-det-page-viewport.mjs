...
const src = join(
  root,
  'tools/website-ux-auditor/docs/design/ux-audit/rule-pages/det-page-viewport.md',
);
const dest = join(root, 'docs/design/ux-audit/rule-pages/det-page-viewport.md');
const expected =
