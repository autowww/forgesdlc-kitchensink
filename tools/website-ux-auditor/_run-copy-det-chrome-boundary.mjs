...
const src = join(
  root,
  "tools/website-ux-auditor/docs/design/ux-audit/rule-pages/det-chrome-boundary.md",
);
const dest = join(root, "docs/design/ux-audit/rule-pages/det-chrome-boundary.md");
