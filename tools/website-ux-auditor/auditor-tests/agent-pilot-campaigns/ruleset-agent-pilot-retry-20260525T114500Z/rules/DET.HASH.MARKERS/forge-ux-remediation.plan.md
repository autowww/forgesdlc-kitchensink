...
overview: "Ordered remediation for Forge website. Run 1 source(s) in this audit | 2 blocker, 1 critical, 3 major, 2 minor, 0 trivial, 0 cosmetic. See body for snapshot, URLs, and top signals. Defect plans generated: 8 (limit 10)."
...
todos:
  ...
  - id: ux-03
    ...
    status: pending
  - id: ux-04
    content: "Execute 04-defect-cta-trust-ecosystem-conversion.md (priority defect plan #4)"
    status: pending
  - id: ux-05
    content: "Execute 05-defect-metadata-a11y-metadata.md (priority defect plan #5)"
    status: pending
  - id: ux-06
    content: "Execute 06-defect-cta-trust-ecosystem-ecosystem.md (priority defect plan #6)"
    status: pending
  - id: ux-07
    content: "Execute 07-defect-readability-structure-messaging.md (priority defect plan #7)"
    status: pending
  - id: ux-08
    content: "Execute 08-defect-design-rule-runtime-informationarchitecture.md (priority defect plan #8)"
    status: pending
isProject: true
---
...
|-------|-------|
| **audit_run_id** | `1155752f1b60c456` |
| **generated_at (UTC)** | `2026-05-25T13:42:28.361Z` |
...
|------:|------|-------|------|------------------:|-----:|
| 1 | `01-defect-product-visual-first-screen.md` | `product-visual` | `first-screen` | +4.00 | 1 |
| 2 | `02-defect-design-rule-runtime-readability.md` | `design-rule-runtime` | `readability` | +10.00 | 1 |
| 3 | `03-defect-design-rule-runtime-visual-catalog.md` | `design-rule-runtime` | `visual-catalog` | +4.00 | 1 |
| 4 | `04-defect-cta-trust-ecosystem-conversion.md` | `cta-trust-ecosystem` | `conversion` | +2.00 | 1 |
| 5 | `05-defect-metadata-a11y-metadata.md` | `metadata-a11y` | `metadata` | +2.00 | 1 |
| 6 | `06-defect-cta-trust-ecosystem-ecosystem.md` | `cta-trust-ecosystem` | `ecosystem` | +2.00 | 1 |
| 7 | `07-defect-readability-structure-messaging.md` | `readability-structure` | `messaging` | +1.00 | 1 |
| 8 | `08-defect-design-rule-runtime-informationarchitecture.md` | `design-rule-runtime` | `informationArchitecture` | +0.00 | 1 |
...
**Mode:** browser crawl (1 page(s)) starting at http://127.0.0.1:60563/.
...
- **critical** [informationArchitecture] Homepage reads as handbook/docs mode instead of public landing/marketing mode above the fold.
...
|-----|-------|-----|---------|----------|-----------|----------------|-------------|-----------------|----------|------------|------------------------|
| http://127.0.0.1:60563/ | 8 | 6 | 18 | 3 | Handbook sample page | 13 | 1 | 0 | 0 | 1 | 2 |
