---
finding_id: 1155752f1b60c456-f02
severity: critical
...
# Root cause task — Forge UX (critical)
...
- **Severity:** critical
- **Area:** informationArchitecture
- **Message:** Homepage reads as handbook/docs mode instead of public landing/marketing mode above the fold.
