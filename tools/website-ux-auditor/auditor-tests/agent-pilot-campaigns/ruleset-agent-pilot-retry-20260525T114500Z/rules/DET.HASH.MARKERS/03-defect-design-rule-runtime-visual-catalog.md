---
title: 03 - Defect: design-rule-runtime (visual-catalog)
...
# 03 - Defect: design-rule-runtime (visual-catalog)
...
- **major+ count:** 0
- **affected URLs:** 1
- **estimated overall score delta if this cluster is fixed:** **+4.00**
...
- This cluster ranks #3 by scorer impact model (homepage cap gates first, then estimated overall score delta, severity weight, and URL coverage).
- Cluster coverage share (findings in this cluster / all findings): 25.0%.
