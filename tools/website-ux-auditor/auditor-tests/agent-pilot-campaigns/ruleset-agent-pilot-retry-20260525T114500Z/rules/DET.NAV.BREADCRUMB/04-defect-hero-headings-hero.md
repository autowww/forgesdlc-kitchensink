---
title: 04 - Defect: hero-headings (hero)
...
- `narrativeHero`: rawDamage 65.00 (1 finding(s))

## Findings sampled from this run

- **BLOCKER** No visible H1 was found. (n/a)
  - Evidence: A clear H1 is required for first-screen comprehension.
  - Remediation hint: Add one dominant outcome-led H1 near the top of the page.

## Related RCA prompts (optional deep dive)

- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f00.md` · blocker · http://127.0.0.1:60536/
