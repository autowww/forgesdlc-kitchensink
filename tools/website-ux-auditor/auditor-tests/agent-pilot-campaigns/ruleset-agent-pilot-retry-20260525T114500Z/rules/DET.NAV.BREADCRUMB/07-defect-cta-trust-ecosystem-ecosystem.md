---
title: 07 - Defect: cta-trust-ecosystem (ecosystem)
...
# 07 - Defect: cta-trust-ecosystem (ecosystem)
...
- **area:** `ecosystem`
- **severity mix:** major:1
- **major+ count:** 1
- **affected URLs:** 1
- **estimated overall score delta if this cluster is fixed:** **+2.00**
- **primary scorer dimension:** Trust model & ecosystem fit
...
- This cluster ranks #7 by scorer impact model (homepage cap gates first, then estimated overall score delta, severity weight, and URL coverage).
- Cluster coverage share (findings in this cluster / all findings): 4.2%.

## Root-cause hypothesis

Likely shared content model/generator section composition issue (trust/ecosystem modules not consistently emitted).
...
- `trustAndEcosystemTruth`: rawDamage 29.00 (1 finding(s))

## Findings sampled from this run

- **MAJOR** The page does not clearly show where it fits in the Forge ecosystem. (n/a)
  - Evidence: 0 ecosystem terms detected.
  - Remediation hint: Add an ecosystem strip linking ForgeSDLC, Lenses, LCDL, Fleet, Platform, and Blueprints where relevant.

## Related RCA prompts (optional deep dive)

- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f02.md` · blocker · http://127.0.0.1:60536/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f03.md` · major · http://127.0.0.1:60536/
