...
- **major+ count:** 0
- **affected URLs:** 1
- **estimated overall score delta if this cluster is fixed:** **+9.00**
...
```text
Affected visual hash: Kbc
Contract: docs/design/catalog/chrome/Kbc-doc-breadcrumb.md
...
- **WARN** Raw hex color #6b7280 is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-queued" property=background hex=#6b7280 url=http://127.0.0.1:60536/
...
- **WARN** Raw hex color #2563eb is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-running" property=background hex=#2563eb url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #b91c1c is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-failed" property=background hex=#b91c1c url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #a16207 is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-cancelled" property=background hex=#a16207 url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__label" property=color hex=#1e293b url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__hint" property=color hex=#334155 url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__mem" property=color hex=#1e293b url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__load-cousin" property=color hex=#334155 url=http://127.0.0.1:60536/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.

## Related RCA prompts (optional deep dive)

- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f06.md` · warn · http://127.0.0.1:60536/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f07.md` · warn · http://127.0.0.1:60536/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f08.md` · warn · http://127.0.0.1:60536/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f09.md` · warn · http://127.0.0.1:60536/
