---
title: 08 - Defect: readability-structure (messaging)
...
# 08 - Defect: readability-structure (messaging)
...
- `narrativeHero`: rawDamage 27.00 (1 finding(s))

## Findings sampled from this run

- **MAJOR** The page may be mechanism-led rather than outcome-led. (n/a)
  - Evidence: 0 outcome terms detected.
  - Remediation hint: Rewrite section headings and cards around user outcomes before mechanisms.

## Related RCA prompts (optional deep dive)

- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f04.md` · major · http://127.0.0.1:60536/
