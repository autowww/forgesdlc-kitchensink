...
- **Audit run id:** `f51744cf3c6f00e2` — **schema:** `2` (see `audit-data.json`)
- **Generated at (UTC):** `2026-05-25T13:42:45.704Z`
...
- **Overall score:** **39** / 100 (schema **v2**) — logarithmic pillar penalties + harmonic blend over **only** URLs that appear above in the crawl tables.
...
|---|---:|---:|---:|---:|---:|
| http://127.0.0.1:60536/ | 4 | 6 | 18 | 6 | 1 |

Findings rollup: **blocker: 3; major: 3; minor: 2**

## Homepage / first analyzed URL — first-screen snapshot

- URL: http://127.0.0.1:60536/
- H1: No visible H1 found.
- Above-fold words: 6
...
|----------|--------|------|-----|---------|
| blocker | high | hero | http://127.0.0.1:60536/ | No visible H1 was found. |
| blocker | high | first-screen | http://127.0.0.1:60536/ | Homepage lacks a hero-scale product/system visual in the first viewport. |
| blocker | high | conversion | http://127.0.0.1:60536/ | No CTAs detected above the fold while the trust model is also insufficiently explicit. |
| major | medium | ecosystem | http://127.0.0.1:60536/ | The page does not clearly show where it fits in the Forge ecosystem. |
| major | medium | messaging | http://127.0.0.1:60536/ | The page may be mechanism-led rather than outcome-led. |
| major | medium | metadata | http://127.0.0.1:60536/ | Meta description is missing or too short. |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-bullet-chart.svg for "bullet" matches only 1/2 required catalog legend node labels (of  |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-pie-donut.svg for "pie" matches only 0/2 required catalog legend node labels (of 4 lege |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-radar.svg for "radar" matches only 1/2 required catalog legend node labels (of 3 legend |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-waterfall.svg for "waterfall" matches only 2/3 required catalog legend node labels (of  |


### Priority detail

- **BLOCKER / hero** (http://127.0.0.1:60536/): No visible H1 was found.
  - Evidence: A clear H1 is required for first-screen comprehension.
  - Remediation: Add one dominant outcome-led H1 near the top of the page.
- **BLOCKER / first-screen** (http://127.0.0.1:60536/): Homepage lacks a hero-scale product/system visual in the first viewport.
...
- **BLOCKER / conversion** (http://127.0.0.1:60536/): No CTAs detected above the fold while the trust model is also insufficiently explicit.
...
- **MAJOR / ecosystem** (http://127.0.0.1:60536/): The page does not clearly show where it fits in the Forge ecosystem.
...
- **MAJOR / messaging** (http://127.0.0.1:60536/): The page may be mechanism-led rather than outcome-led.
  - Evidence: 0 outcome terms detected.
  - Remediation: Rewrite section headings and cards around user outcomes before mechanisms.
- **MAJOR / metadata** (http://127.0.0.1:60536/): Meta description is missing or too short.
...
- **WARN / visual-catalog** (http://127.0.0.1:60536/): Template SVG assets/svg/template-bullet-chart.svg for "bullet" matches only 1/2 required catalog legend node labels (of 4 legend entries).
...
- **WARN / visual-catalog** (http://127.0.0.1:60536/): Template SVG assets/svg/template-pie-donut.svg for "pie" matches only 0/2 required catalog legend node labels (of 4 legend entries).
  ...
  - Remediation: Align SVG text nodes with catalog legend `items[].node` strings for the data-diagram-key, or update the catalog legend when labels were intentionally renamed.
- **WARN / visual-catalog** (http://127.0.0.1:60536/): Template SVG assets/svg/template-radar.svg for "radar" matches only 1/2 required catalog legend node labels (of 3 legend entries).
  ...
  - Remediation: Align SVG text nodes with catalog legend `items[].node` strings for the data-diagram-key, or update the catalog legend when labels were intentionally renamed.
- **WARN / visual-catalog** (http://127.0.0.1:60536/): Template SVG assets/svg/template-waterfall.svg for "waterfall" matches only 2/3 required catalog legend node labels (of 5 legend entries).
...
|----------|--------|------|-----|---------|----------------|
| blocker | high | hero | http://127.0.0.1:60536/ | No visible H1 was found. | A clear H1 is required for first-screen comprehension. |
| blocker | high | first-screen | http://127.0.0.1:60536/ | Homepage lacks a hero-scale product/system visual in the first viewport. | main_hero_visual_above_fold_count=0 |
| blocker | high | conversion | http://127.0.0.1:60536/ | No CTAs detected above the fold while the trust model is also insufficiently explicit. | 0 trust terms; no matched CTA verbs above fold. |
| major | medium | ecosystem | http://127.0.0.1:60536/ | The page does not clearly show where it fits in the Forge ecosystem. | 0 ecosystem terms detected. |
| major | medium | messaging | http://127.0.0.1:60536/ | The page may be mechanism-led rather than outcome-led. | 0 outcome terms detected. |
| major | medium | metadata | http://127.0.0.1:60536/ | Meta description is missing or too short. | No meta description found. |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-bullet-chart.svg for "bullet" matches only 1/2 required catalog leg | diagram-labels-legend-gap key=bullet svg=assets/svg/template-bullet-chart.svg ma |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-pie-donut.svg for "pie" matches only 0/2 required catalog legend no | diagram-labels-legend-gap key=pie svg=assets/svg/template-pie-donut.svg matched= |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-radar.svg for "radar" matches only 1/2 required catalog legend node | diagram-labels-legend-gap key=radar svg=assets/svg/template-radar.svg matched=1  |
| warn | medium | visual-catalog | http://127.0.0.1:60536/ | Template SVG assets/svg/template-waterfall.svg for "waterfall" matches only 2/3 required catalog leg | diagram-labels-legend-gap key=waterfall svg=assets/svg/template-waterfall.svg ma |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #6b7280 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-queued" p |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #2563eb is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-running"  |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #b91c1c is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-failed" p |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #a16207 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".st-cancelled |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector=".fleet-tile-- |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #e2e8f0 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| warn | medium | readability | http://127.0.0.1:60536/ | Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanc | raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-them |
| minor | medium | visual-catalog | http://127.0.0.1:60536/ | generator/bootstrap_missing_rule_pages.py inlines governed KS hash attributes (/data-ks-hash\s*=\s*[ | python_source=generator/bootstrap_missing_rule_pages.py kind=manual-literal |
| minor | medium | visual-catalog | http://127.0.0.1:60536/ | generator/build_rule_defect_fixtures.py inlines governed KS hash attributes (/data-ks-hash\s*=\s*["' | python_source=generator/build_rule_defect_fixtures.py kind=manual-literal |
...
- screenshots/01-127-0-0-1-60536.png
- screenshots/00-mobile-127-0-0-1-60536.png
