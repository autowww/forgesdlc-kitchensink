---
title: 06 - Defect: metadata-a11y (metadata)
...
# 06 - Defect: metadata-a11y (metadata)
...
- This cluster ranks #6 by scorer impact model (homepage cap gates first, then estimated overall score delta, severity weight, and URL coverage).
...
- `accessibilitySemanticsMeta`: rawDamage 32.00 (1 finding(s))

## Findings sampled from this run

- **MAJOR** Meta description is missing or too short. (n/a)
  - Evidence: No meta description found.
  - Remediation hint: Add a 120-160 character description that states what the product is and why it matters.

## Related RCA prompts (optional deep dive)

- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.NAV.BREADCRUMB/rca-prompts/f51744cf3c6f00e2-f05.md` · major · http://127.0.0.1:60536/
