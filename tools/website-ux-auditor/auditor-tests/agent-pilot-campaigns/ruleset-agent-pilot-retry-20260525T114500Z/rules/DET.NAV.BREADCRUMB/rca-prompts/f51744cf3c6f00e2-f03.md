---
finding_id: f51744cf3c6f00e2-f03
severity: major
...
# Root cause task — Forge UX (major)
...
- **Severity:** major
- **Area:** ecosystem
- **Message:** The page does not clearly show where it fits in the Forge ecosystem.
- **Evidence:** 0 ecosystem terms detected.

## Suggested remediation (heuristic only)

Add an ecosystem strip linking ForgeSDLC, Lenses, LCDL, Fleet, Platform, and Blueprints where relevant.
