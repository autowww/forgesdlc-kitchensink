...
- **Severity:** major
- **Area:** messaging
- **Message:** The page may be mechanism-led rather than outcome-led.
- **Evidence:** 0 outcome terms detected.

## Suggested remediation (heuristic only)

Rewrite section headings and cards around user outcomes before mechanisms.
