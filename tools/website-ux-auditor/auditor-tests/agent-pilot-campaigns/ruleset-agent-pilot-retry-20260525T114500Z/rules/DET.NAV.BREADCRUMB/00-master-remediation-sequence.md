...
- [ ] **Defect-first remediation** (top 8/10)
  - [ ] 01 - product-visual (first-screen) · est Δ +3.00 · 1 URL(s)
  - [ ] 02 - design-rule-runtime (readability) · est Δ +9.00 · 1 URL(s)
  - [ ] 03 - design-rule-runtime (visual-catalog) · est Δ +4.00 · 1 URL(s)
  - [ ] 04 - hero-headings (hero) · est Δ +2.00 · 1 URL(s)
  - [ ] 05 - cta-trust-ecosystem (conversion) · est Δ +2.00 · 1 URL(s)
  - [ ] 06 - metadata-a11y (metadata) · est Δ +2.00 · 1 URL(s)
  - [ ] 07 - cta-trust-ecosystem (ecosystem) · est Δ +2.00 · 1 URL(s)
  - [ ] 08 - readability-structure (messaging) · est Δ +0.00 · 1 URL(s)
