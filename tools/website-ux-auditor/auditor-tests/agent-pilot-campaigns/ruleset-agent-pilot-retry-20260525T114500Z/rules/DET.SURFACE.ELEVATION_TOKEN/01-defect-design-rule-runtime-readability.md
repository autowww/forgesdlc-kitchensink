...
- **major+ count:** 0
- **affected URLs:** 1
- **estimated overall score delta if this cluster is fixed:** **+15.00**
...
- **WARN** Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__label" property=color hex=#1e293b url=http://127.0.0.1:60577/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__hint" property=color hex=#334155 url=http://127.0.0.1:60577/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #1e293b is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__mem" property=color hex=#1e293b url=http://127.0.0.1:60577/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
- **WARN** Raw hex color #334155 is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens. (n/a)
  - Evidence: raw_hex_outside_allowlist path=css/forge-fleet-admin.css selector="[data-bs-theme="light"] .fleet-tile .fleet-tile__load-cousin" property=color hex=#334155 url=http://127.0.0.1:60577/
  - Remediation hint: Replace raw hex literals with theme custom properties (e.g. var(--forge-cyan)) or add the value to a theme pack token definition instead of feature CSS.
