---
title: 05 - Defect: readability-structure (readability)
...
# 05 - Defect: readability-structure (readability)
...
- **area:** `readability`
- **severity mix:** minor:1
- **major+ count:** 0
- **affected URLs:** 1
- **estimated overall score delta if this cluster is fixed:** **+1.00**
...
- This cluster ranks #5 by scorer impact model (homepage cap gates first, then estimated overall score delta, severity weight, and URL coverage).
- Cluster coverage share (findings in this cluster / all findings): 4.8%.

## Root-cause hypothesis

Likely content architecture pattern issue (generator output, page template density, docs leakage into landing paths).
...
- `depthAndTechnicalDisclosure`: rawDamage 15.00 (1 finding(s))

## Findings sampled from this run

- **MINOR** Measured paragraph width suggests very long line lengths (readability / enterprise polish). (n/a)
  - Evidence: max_paragraph_measure_px=1392
  - Remediation hint: Constrain reading measure with grid layouts or max-width containers for body copy.

## Related RCA prompts (optional deep dive)

- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.SURFACE.ELEVATION_TOKEN/rca-prompts/a181da4d5d587565-f06.md` · warn · http://127.0.0.1:60577/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.SURFACE.ELEVATION_TOKEN/rca-prompts/a181da4d5d587565-f07.md` · warn · http://127.0.0.1:60577/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.SURFACE.ELEVATION_TOKEN/rca-prompts/a181da4d5d587565-f08.md` · warn · http://127.0.0.1:60577/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.SURFACE.ELEVATION_TOKEN/rca-prompts/a181da4d5d587565-f09.md` · warn · http://127.0.0.1:60577/
