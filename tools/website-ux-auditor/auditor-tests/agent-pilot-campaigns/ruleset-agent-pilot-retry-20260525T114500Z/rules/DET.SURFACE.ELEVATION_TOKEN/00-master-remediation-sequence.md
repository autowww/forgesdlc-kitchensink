...
- [ ] **Defect-first remediation** (top 5/10)
  - [ ] 01 - design-rule-runtime (readability) · est Δ +15.00 · 1 URL(s)
  - [ ] 02 - design-rule-runtime (visual-catalog) · est Δ +8.00 · 1 URL(s)
  - [ ] 03 - metadata-a11y (accessibility) · est Δ +2.00 · 1 URL(s)
  - [ ] 04 - design-rule-runtime (accessibility) · est Δ +2.00 · 1 URL(s)
  - [ ] 05 - readability-structure (readability) · est Δ +1.00 · 1 URL(s)
