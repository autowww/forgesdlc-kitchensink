---
finding_id: a181da4d5d587565-f01
severity: major
...
- **Severity:** major
- **Area:** accessibility
- **Message:** Body UI text has insufficient contrast (3.81:1) against its background; WCAG AA requires at least 4.5:1 for this font size.
