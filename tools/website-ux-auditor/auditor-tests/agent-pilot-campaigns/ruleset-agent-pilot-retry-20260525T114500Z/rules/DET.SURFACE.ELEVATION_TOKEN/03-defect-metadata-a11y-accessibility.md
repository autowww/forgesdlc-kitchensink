---
title: 03 - Defect: metadata-a11y (accessibility)
...
# 03 - Defect: metadata-a11y (accessibility)
...
- **MAJOR** Potential low-contrast text was detected. (n/a)
  - Evidence: 1 samples below expected contrast thresholds.
  - Remediation hint: Increase foreground/background contrast for text, links, and CTAs.
