...
overview: "Ordered remediation for Forge website. Run 2 source(s) in this audit | 0 blocker, 0 critical, 0 major, 6 minor, 0 trivial, 0 cosmetic. See body for snapshot, URLs, and top signals. Defect plans generated: 4 (limit 10)."
...
todos:
  ...
  - id: ux-02
    ...
    status: pending
  - id: ux-03
    content: "Execute 03-defect-visual-catalog-awareness-visual-catalog.md (priority defect plan #3)"
    status: pending
  - id: ux-04
    content: "Execute 04-defect-readability-structure-readability.md (priority defect plan #4)"
    status: pending
isProject: true
---
...
|-------|-------|
| **audit_run_id** | `8f895c64766e014e` |
| **generated_at (UTC)** | `2026-05-25T13:42:33.120Z` |
...
|------:|------|-------|------|------------------:|-----:|
| 1 | `01-defect-design-rule-runtime-readability.md` | `design-rule-runtime` | `readability` | +22.00 | 2 |
| 2 | `02-defect-design-rule-runtime-visual-catalog.md` | `design-rule-runtime` | `visual-catalog` | +8.00 | 2 |
| 3 | `03-defect-visual-catalog-awareness-visual-catalog.md` | `visual-catalog-awareness` | `visual-catalog` | +2.00 | 2 |
| 4 | `04-defect-readability-structure-readability.md` | `readability-structure` | `readability` | +2.00 | 2 |
...
**Mode:** browser crawl (2 page(s)) starting at http://127.0.0.1:60517/.

**Crawl outcome:** `normal_completion` — Major+ count `0`; queued URLs `7`; page capture budget `2`. Use `--breadth-crawl` (alias `--stop-disable`) to crawl full `--max-pages` breadth regardless of backlog.

**Findings (by tier):** minor: 6

Severity counts use schema v2 (`audit-data.json`). See report appendix for the ladder definitions.

### Pages / sources

- http://127.0.0.1:60517/
- http://127.0.0.1:60517/index.html

### Top signals (max 10)

- **warn** [visual-catalog] KS visual hash Msm appears on 2 elements — verify this is intentional for reusable surfaces.
...
_Top ten preview; **42 findings** flattened in `audit-report.md` → **All findings this run** Major+ crawl governor **was off** (`--breadth-crawl`)._
...
|-----|-------|-----|---------|----------|-----------|----------------|-------------|-----------------|----------|------------|------------------------|
| http://127.0.0.1:60517/ | 20 | 0 | 21 | 6 | Govern workspace delivery with traceable evidence | 94 | 11 | 6 | 4 | 0 | 0 |
| http://127.0.0.1:60517/index.html | 20 | 0 | 21 | 6 | Govern workspace delivery with traceable evidence | 94 | 11 | 6 | 4 | 0 | 0 |
