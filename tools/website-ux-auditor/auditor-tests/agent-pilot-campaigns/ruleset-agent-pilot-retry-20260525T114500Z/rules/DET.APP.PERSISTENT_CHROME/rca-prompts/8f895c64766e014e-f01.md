---
finding_id: 8f895c64766e014e-f01
severity: warn
legacy_severity_for_tools: medium
area: visual-catalog
url: http://127.0.0.1:60517/
audit_run_id: 8f895c64766e014e
check_id: design-rule-runtime
---

# Root cause task — Forge UX (warn)
...
- **Severity:** warn
- **Area:** visual-catalog
- **Message:** Template SVG assets/svg/template-bullet-chart.svg for "bullet" matches only 1/2 required catalog legend node labels (of 4 legend entries).
...
Relative path from audit output folder: `screenshots/01-127-0-0-1-60517.png`
