---
finding_id: 8f895c64766e014e-f02
severity: warn
...
- **Severity:** warn
- **Area:** visual-catalog
- **Message:** Template SVG assets/svg/template-pie-donut.svg for "pie" matches only 0/2 required catalog legend node labels (of 4 legend entries).
