---
finding_id: 8f895c64766e014e-f04
severity: warn
...
- **Severity:** warn
- **Area:** visual-catalog
- **Message:** Template SVG assets/svg/template-waterfall.svg for "waterfall" matches only 2/3 required catalog legend node labels (of 5 legend entries).
