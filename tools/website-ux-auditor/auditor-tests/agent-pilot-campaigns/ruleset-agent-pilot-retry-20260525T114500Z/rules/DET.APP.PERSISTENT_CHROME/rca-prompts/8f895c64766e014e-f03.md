---
finding_id: 8f895c64766e014e-f03
severity: warn
...
- **Severity:** warn
- **Area:** visual-catalog
- **Message:** Template SVG assets/svg/template-radar.svg for "radar" matches only 1/2 required catalog legend node labels (of 3 legend entries).
