---
finding_id: 8f895c64766e014e-f07
severity: warn
...
- **Severity:** warn
- **Area:** readability
- **Message:** Raw hex color #2563eb is used outside the theme token allowlist; prefer var(--forge-*) or other sanctioned design tokens.
