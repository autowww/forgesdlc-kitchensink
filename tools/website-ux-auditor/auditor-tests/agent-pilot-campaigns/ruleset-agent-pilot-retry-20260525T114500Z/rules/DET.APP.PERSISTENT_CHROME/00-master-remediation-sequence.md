...
- [ ] **Defect-first remediation** (top 4/10)
  - [ ] 01 - design-rule-runtime (readability) · est Δ +22.00 · 2 URL(s)
  - [ ] 02 - design-rule-runtime (visual-catalog) · est Δ +8.00 · 2 URL(s)
  - [ ] 03 - visual-catalog-awareness (visual-catalog) · est Δ +2.00 · 2 URL(s)
  - [ ] 04 - readability-structure (readability) · est Δ +2.00 · 2 URL(s)
