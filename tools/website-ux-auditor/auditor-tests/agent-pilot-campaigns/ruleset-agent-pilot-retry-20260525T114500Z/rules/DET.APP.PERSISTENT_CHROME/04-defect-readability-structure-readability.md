---
title: 04 - Defect: readability-structure (readability)
...
# 04 - Defect: readability-structure (readability)
...
- `depthAndTechnicalDisclosure`: rawDamage 30.00 (2 finding(s))
...
- **MINOR** Measured paragraph width suggests very long line lengths (readability / enterprise polish). (n/a)
  - Evidence: max_paragraph_measure_px=1184
...
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.APP.PERSISTENT_CHROME/rca-prompts/8f895c64766e014e-f06.md` · warn · http://127.0.0.1:60517/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.APP.PERSISTENT_CHROME/rca-prompts/8f895c64766e014e-f07.md` · warn · http://127.0.0.1:60517/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.APP.PERSISTENT_CHROME/rca-prompts/8f895c64766e014e-f08.md` · warn · http://127.0.0.1:60517/
- `tools/website-ux-auditor/auditor-tests/agent-pilot-campaigns/ruleset-agent-pilot-retry-20260525T114500Z/rules/DET.APP.PERSISTENT_CHROME/rca-prompts/8f895c64766e014e-f09.md` · warn · http://127.0.0.1:60517/
