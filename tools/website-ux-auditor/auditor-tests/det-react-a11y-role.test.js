...
import {
  findingsFromReactA11yRoleReport,
  run,
} from '../design-rules/deterministic/generated/det-react-a11y-role.check.js';

test('findingsFromReactA11yRoleReport flags role/state violations on react primitives', () => {
  const findings = findingsFromReactA11yRoleReport({
...
test('run uses metrics.reactA11yRoleReport when provided', async () => {
