/**
 * Nested drill-down roadmap — mount on `.ks-nested-roadmap` + JSON in `script[data-ks-nrm-config]`.
 * Expects modal `#ksNestedRoadmapModal` (from `render_nested_roadmap_modal_shell`) unless overridden.
 */
(function () {
  'use strict';
  ...
  function boot() {
    var roots = document.querySelectorAll('[data-ks-nested-roadmap]');
