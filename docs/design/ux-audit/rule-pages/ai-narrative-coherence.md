...
page_version: 3e1187c7e66cb94ddb158cf40e3b1769a235a7e9f8c8c875ff6cdbb1041dc4e1
...
- `AI.VISUAL.HIERARCHY_CONFIDENCE` — focal path supports hero → proof → depth read order.
