---
rule_id: AI.REACT.PRIMITIVE_CONSISTENCY
lane: ai
...
page_version: a8fc1f6189cc2753343c4c952614d91f8d4c22febaf51d040bc907cf2f8c5529
...
source_rule: docs/design/ux-audit/ai-enabled-design-principles.md#ai-react-primitive-consistency
related_rules:
  - DET.REACT.KS_ATTRS
  - DET.REACT.A11Y_ROLE
  - DET.HASH.MARKERS
...
- `DET.REACT.KS_ATTRS` — primitive roots emit `data-ks-hash`, `data-ks-type`, `data-ks-name`, and `data-ks-react-root`.
- `DET.REACT.A11Y_ROLE` — interactive primitives expose correct ARIA roles, labels, and keyboard behavior.
