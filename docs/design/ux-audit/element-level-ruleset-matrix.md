...
| **Studio / enterprise operator SPAs** | `DET.STUDIO.H1`, `DET.STUDIO.TITLE_NAV_MATCH`, `DET.STUDIO.JOB_BUDGET`, `DET.STUDIO.MECHANISM_LEAD`, `DET.STUDIO.FULLPAGE_SHOT`, `DET.STUDIO.HASH`, `DET.STUDIO.TESTID`, `DET.BUTTON.GROUP.MAX`, `DET.APP.PRIMARY_CTA`, `DET.APP.TAB_PANEL` | `AI.APP.DENSITY_BALANCE`, `AI.APP.WORKFLOW_CONTINUITY`, `AI.DASHBOARD.ACTIONABILITY_PRIORITY`, `AI.PREMIUM.ENTERPRISE_FEEL` | `primary_job`, `mode_tabs`, `rail_contract`, `lead_copy`, `ks_component_remediation`, `hash` |
