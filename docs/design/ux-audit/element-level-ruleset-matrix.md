...
| **CTA / button groups** | `DET.CTA.HIERARCHY`, `DET.CTA.LABEL_NONEMPTY`, `DET.BUTTON.GROUP.MAX` | `AI.VISUAL.HIERARCHY`, `AI.CREDIBILITY.NO_OVERCLAIM`, `AI.INFORMATION_SCENT.NEXT_STEP` | `primary_cta`, `secondary_cta`, `destructive_allowed`, `alignment`, `hash` |
| **Data / chart components** | `DET.DATA.TABLE_HEADERS`, `DET.CHART.ALT_SUMMARY`, `DET.DATA.COLOR_ONLY` | `AI.DATA.INSIGHT_LEGIBILITY`, `AI.VISUAL.PRODUCT_EXPLANATORY_VALUE`, `AI.TRUST.DATA_FRESHNESS_PROVENANCE`, `AI.DASHBOARD.ACTIONABILITY_PRIORITY` | `dataset_shape`, `caption_policy`, `accent_colors`, `interaction_contract`, `hash` |
...
| **Desktop / app interfaces** | `DET.APP.FOCUS_TRAP`, `DET.APP.PERSISTENT_CHROME`, `DET.APP.PRIMARY_STATE`, `DET.APP.PRIMARY_CTA`, `DET.APP.DEMO_DISCLOSURE`, `DET.APP.TAB_PANEL`, `DET.APP.ROUTE_DEEPLINK_STATE`, `DET.APP.ERROR_BOUNDARY_RECOVERY`, `DET.APP.EMPTY_LOADING_ERROR_SUCCESS`, `DET.APP.TOAST_LIFECYCLE`, `DET.APP.WIZARD_PROGRESS_CONTROLS`, `DET.LANDMARKS.REQUIRED` | `AI.APP.DENSITY_BALANCE`, `AI.APP.WORKFLOW_CONTINUITY`, `AI.APP.WORKFLOW_RISK_GUARDRAILS` | `shell_regions`, `route_contract`, `density_level`, `keyboard_map`, `state_regions`, `hash` |
| **Studio / enterprise operator SPAs** | `DET.STUDIO.*`, `DET.BUTTON.GROUP.MAX`, `DET.APP.PRIMARY_CTA`, `DET.APP.TAB_PANEL`, `DET.APP.BULK_ACTION_SCOPE`, `DET.APP.DATA_REFRESH_STALENESS`, `DET.APP.EMPTY_LOADING_ERROR_SUCCESS`, `DET.APP.DISABLED_REASON`, `DET.APP.TOAST_LIFECYCLE`, `DET.APP.PRIMARY_STATE`, `DET.FORM.LABEL_ERROR_SUMMARY` | `AI.APP.DENSITY_BALANCE`, `AI.APP.WORKFLOW_CONTINUITY`, `AI.DASHBOARD.ACTIONABILITY_PRIORITY`, `AI.PREMIUM.ENTERPRISE_FEEL` | `primary_job`, `mode_tabs`, `rail_contract`, `lead_copy`, `ks_component_remediation`, `ent_app_principle`, `hash` |
| **React primitives** | `DET.APP.PRIMITIVE_MARKERS`, `DET.APP.CONTROL_A11Y`, `DET.APP.PRIMITIVE_SOURCE`, `DET.HASH.MARKERS` | `AI.APP.PRIMITIVE_CONSISTENCY`, `AI.CONTRACT.IMPLEMENTATION_USEFULNESS` | `props_surface`, `states`, `a11y_notes`, `story_urls`, `hash` |
