...
page_version: 569a6cc084827e8b5e52cee28a5675b4fcd4a10f59e618a2864d6b922e4ff180
...
```html
<div data-ks-embed-main class="p-3 forge-card" data-a11y-example="fail"><h2 class="h6">Contrast</h2><p class="forge-support mb-2">Low contrast text or UI component.</p><p class="mb-0 small">Rule: <code>DET.A11Y.GENERIC.CONTRAST</code> · scope: generic</p></div>
```

## After example

```html
<div data-ks-embed-main class="p-3 forge-card" data-a11y-example="pass"><h2 class="h6">Contrast (remediated)</h2><p class="mb-2">Contrast meets the profile threshold.</p><p class="mb-0 small text-muted">Deterministic accessibility check (generic scope).</p></div>
```
