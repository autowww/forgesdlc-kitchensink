...
page_version: 5894092615021bce843dbe56a721c6e2647777ae40d9f58170ea1166d007cf62
...
```html
<div data-ks-embed-main class="p-3 forge-card" data-a11y-example="fail"><h2 class="h6">Consistent Nav</h2><p class="forge-support mb-2">Navigation or link purpose is unclear.</p><p class="mb-0 small">Rule: <code>DET.A11Y.GENERIC.CONSISTENT_NAV</code> · scope: generic</p></div>
```

## After example

```html
<div data-ks-embed-main class="p-3 forge-card" data-a11y-example="pass"><h2 class="h6">Consistent Nav (remediated)</h2><p class="mb-2">Navigation is consistent; link purpose is clear in context.</p><p class="mb-0 small text-muted">Deterministic accessibility check (generic scope).</p></div>
```
