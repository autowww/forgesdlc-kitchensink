---
rule_id: AI.A11Y.GENERIC.ERROR_PREVENTION
lane: ai
scope: generic
...
- Auditor emits a finding with `ruleId` `AI.A11Y.GENERIC.ERROR_PREVENTION` on the crawled URL.
- Harness: `auditor-tests/invoke-a11y-ruleset-harness.sh AI.A11Y.GENERIC.ERROR_PREVENTION` expects ≥1 finding on the Before fixture.
...
1. Reproduce with `analyze-website-a11y.mjs --only-deterministic-rule-ids AI.A11Y.GENERIC.ERROR_PREVENTION` when lane is deterministic.
