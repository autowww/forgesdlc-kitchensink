---
rule_id: AI.A11Y.GENERIC.CONTEXT_HELP
lane: ai
scope: generic
title: Context Help
...
- Auditor emits a finding with `ruleId` `AI.A11Y.GENERIC.CONTEXT_HELP` on the crawled URL.
- Harness: `auditor-tests/invoke-a11y-ruleset-harness.sh AI.A11Y.GENERIC.CONTEXT_HELP` expects ≥1 finding on the Before fixture.
...
1. Reproduce with `analyze-website-a11y.mjs --only-deterministic-rule-ids AI.A11Y.GENERIC.CONTEXT_HELP` when lane is deterministic.
