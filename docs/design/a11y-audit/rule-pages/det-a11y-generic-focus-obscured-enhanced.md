---
rule_id: DET.A11Y.GENERIC.FOCUS_OBSCURED_ENHANCED
lane: deterministic
scope: generic
...
- Auditor emits a finding with `ruleId` `DET.A11Y.GENERIC.FOCUS_OBSCURED_ENHANCED` on the crawled URL.
- Harness: `auditor-tests/invoke-a11y-ruleset-harness.sh DET.A11Y.GENERIC.FOCUS_OBSCURED_ENHANCED` expects ≥1 finding on the Before fixture.
...
1. Reproduce with `analyze-website-a11y.mjs --only-deterministic-rule-ids DET.A11Y.GENERIC.FOCUS_OBSCURED_ENHANCED` when lane is deterministic.
