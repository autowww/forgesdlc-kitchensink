...
page_version: e168fe232603595c53bae41c7bb55a359d7236f1d43f5044584f4db63a8ddba4
...
```html
<div data-ks-embed-main class="p-3 forge-card" data-a11y-example="fail"><h2 class="h6">Link Purpose</h2><p class="forge-support mb-2">Navigation or link purpose is unclear.</p><p class="mb-0 small">Rule: <code>DET.A11Y.GENERIC.LINK_PURPOSE</code> · scope: generic</p></div>
```

## After example

```html
<div data-ks-embed-main class="p-3 forge-card" data-a11y-example="pass"><h2 class="h6">Link Purpose (remediated)</h2><p class="mb-2">Navigation is consistent; link purpose is clear in context.</p><p class="mb-0 small text-muted">Deterministic accessibility check (generic scope).</p></div>
```
