...
understandingUrl: "https://www.w3.org/WAI/WCAG21/Understanding/reflow"
...
Reflow (Level AA) — Principle 1; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.VIEWPORT`


## Operator notes

Run axe with a profile that includes SC 1.4.10, then confirm DET/AI mappings below.
...
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG21/Understanding/reflow) techniques where applicable.
