...
understandingUrl: "https://www.w3.org/WAI/WCAG21/Understanding/non-text-content"
...
Non-text Content (WCAG 2.1 Level A) ensures content remains perceivable, operable, understandable, or robust for people with disabilities. This page paraphrases the intent for Forge operators; see the normative [W3C specification](https://www.w3.org/TR/WCAG21/#non-text-content) for legal text.
...
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG21/Understanding/non-text-content) techniques where applicable.
