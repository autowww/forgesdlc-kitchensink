...
understandingUrl: "https://www.w3.org/WAI/WCAG21/Understanding/text-spacing"
forgeDetRules: ["DET.A11Y.GENERIC.TEXT_SPACING"]
forgeAiRules: []
manualOnly: false
---
...
Text Spacing (Level AA) — Principle 1; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.TEXT_SPACING`


## Operator notes

Run axe with a profile that includes SC 1.4.12, then confirm DET/AI mappings below.
...
- Meet the success criterion as described in the W3C TR for **1.4.12**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.TEXT_SPACING |
| AI | — |
| Manual | Use axe + DET where mapped |

## Manual test steps

1. Identify pages or components in scope for **1.4.12**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG21/Understanding/text-spacing) techniques where applicable.
