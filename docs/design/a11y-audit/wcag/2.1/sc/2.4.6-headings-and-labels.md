...
Headings and Labels (WCAG 2.1 Level AA) ensures content remains perceivable, operable, understandable, or robust for people with disabilities. This page paraphrases the intent for Forge operators; see the normative [W3C specification](https://www.w3.org/TR/WCAG21/#headings-and-labels) for legal text.
