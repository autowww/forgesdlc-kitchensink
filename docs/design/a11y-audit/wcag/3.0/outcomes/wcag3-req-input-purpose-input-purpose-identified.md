---
id: "WCAG3-REQ-INPUT-PURPOSE"
title: "Input purpose identified"
...
# WCAG3-REQ-INPUT-PURPOSE — Input purpose identified

## Summary

Draft WCAG 3.0 requirement under guideline **Forms**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.3.5), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
