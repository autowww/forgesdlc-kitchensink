...
# WCAG3-REQ-CONTRAST-TEXT — Text contrast (minimum)
...
- Where `mapsToWcag22` is listed (1.4.3), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
