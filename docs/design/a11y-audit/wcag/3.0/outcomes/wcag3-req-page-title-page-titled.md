...
# WCAG3-REQ-PAGE-TITLE — Page titled
...
- Where `mapsToWcag22` is listed (2.4.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
