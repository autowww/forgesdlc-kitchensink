---
id: "WCAG3-REQ-SENSORY"
title: "Instructions not sensory-only"
...
Draft WCAG 3.0 requirement under guideline **Clear words**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.3.3), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
