...
Draft WCAG 3.0 requirement under guideline **Help**. Tier: **supplemental**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (3.2.6), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
