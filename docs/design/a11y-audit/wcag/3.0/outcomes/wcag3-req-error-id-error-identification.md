...
# WCAG3-REQ-ERROR-ID — Error identification
...
- Where `mapsToWcag22` is listed (3.3.1), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
