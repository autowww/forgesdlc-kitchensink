---
id: "WCAG3-REQ-TEXT-SPACING"
title: "Text spacing adjustable"
...
# WCAG3-REQ-TEXT-SPACING — Text spacing adjustable

## Summary

Draft WCAG 3.0 requirement under guideline **Visual presentation**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.4.12), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
