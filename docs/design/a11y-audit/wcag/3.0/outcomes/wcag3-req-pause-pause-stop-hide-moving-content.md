...
# WCAG3-REQ-PAUSE — Pause, stop, hide moving content

## Summary

Draft WCAG 3.0 requirement under guideline **Timing**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (2.2.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
