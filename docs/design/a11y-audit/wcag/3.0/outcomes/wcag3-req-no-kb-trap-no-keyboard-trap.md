...
# WCAG3-REQ-NO-KB-TRAP — No keyboard trap
...
- Where `mapsToWcag22` is listed (2.1.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
