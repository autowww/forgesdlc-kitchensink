...
# WCAG3-REQ-ERROR-SUGGEST — Error suggestions
...
- Where `mapsToWcag22` is listed (3.3.3), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
