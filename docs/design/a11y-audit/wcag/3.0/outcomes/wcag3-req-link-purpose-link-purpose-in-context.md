...
# WCAG3-REQ-LINK-PURPOSE — Link purpose in context

## Summary

Draft WCAG 3.0 requirement under guideline **Navigation**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (2.4.4), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
