...
# WCAG3-REQ-NAME-ROLE-VALUE — Name, role, value

## Summary

Draft WCAG 3.0 requirement under guideline **Compatibility**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (4.1.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
