...
# WCAG3-REQ-SEIZURE — Three flashes or below threshold

## Summary

Draft WCAG 3.0 requirement under guideline **Seizures**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (2.3.1), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
