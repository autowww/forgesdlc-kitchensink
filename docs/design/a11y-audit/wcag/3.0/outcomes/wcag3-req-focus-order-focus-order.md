...
# WCAG3-REQ-FOCUS-ORDER — Focus order
...
- Where `mapsToWcag22` is listed (2.4.3), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
