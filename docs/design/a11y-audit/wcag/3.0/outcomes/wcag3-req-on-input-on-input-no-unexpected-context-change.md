---
id: "WCAG3-REQ-ON-INPUT"
title: "On input no unexpected context change"
...
# WCAG3-REQ-ON-INPUT — On input no unexpected context change

## Summary

Draft WCAG 3.0 requirement under guideline **Predictable**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (3.2.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
