...
# WCAG3-REQ-FOCUS-APPEARANCE — Focus appearance
...
- Where `mapsToWcag22` is listed (2.4.13), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
