---
id: "WCAG3-REQ-NON-TEXT-CONTRAST"
...
# WCAG3-REQ-NON-TEXT-CONTRAST — Non-text contrast

## Summary

Draft WCAG 3.0 requirement under guideline **Visual contrast**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.4.11), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
