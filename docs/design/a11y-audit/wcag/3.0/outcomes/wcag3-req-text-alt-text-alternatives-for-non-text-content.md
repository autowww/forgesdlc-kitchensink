...
# WCAG3-REQ-TEXT-ALT — Text alternatives for non-text content

## Summary

Draft WCAG 3.0 requirement under guideline **Text alternatives**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.1.1), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
