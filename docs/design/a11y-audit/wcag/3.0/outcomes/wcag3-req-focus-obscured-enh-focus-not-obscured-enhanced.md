---
id: "WCAG3-REQ-FOCUS-OBSCURED-ENH"
...
# WCAG3-REQ-FOCUS-OBSCURED-ENH — Focus not obscured (enhanced)

## Summary

Draft WCAG 3.0 requirement under guideline **Navigation**. Tier: **supplemental**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (2.4.12), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
