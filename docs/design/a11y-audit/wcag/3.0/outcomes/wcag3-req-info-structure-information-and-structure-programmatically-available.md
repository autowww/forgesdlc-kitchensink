---
id: "WCAG3-REQ-INFO-STRUCTURE"
title: "Information and structure programmatically available"
...
# WCAG3-REQ-INFO-STRUCTURE — Information and structure programmatically available

## Summary

Information and structure programmatically available — WCAG 3.0 draft (core). Guideline: Structure.


## Operator notes

Bronze/Silver/Gold tier requirement; maps to WCAG 2.2: 1.3.1.
...
- Where `mapsToWcag22` is listed (1.3.1), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
