---
id: "WCAG3-REQ-ORG-PRACTICES"
title: "Organizational accessibility practices"
conformanceTier: "supplemental"
wcagVersion: "3.0"
specUrl: "https://www.w3.org/TR/wcag-3.0/"
mapsToWcag22: ["3.3.4", "3.3.6"]
manualOnly: true
---
...
Organizational accessibility practices — WCAG 3.0 draft (supplemental). Guideline: Process.


## Operator notes

Bronze/Silver/Gold tier requirement; maps to WCAG 2.2: 3.3.4, 3.3.6.
...
- Where `mapsToWcag22` is listed (3.3.4, 3.3.6), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
