...
# WCAG3-REQ-KEYWORD — Keyboard operable

## Summary

Keyboard operable — WCAG 3.0 draft (core). Guideline: Keyboard.


## Operator notes

Bronze/Silver/Gold tier requirement; maps to WCAG 2.2: 2.1.1.
...
- Where `mapsToWcag22` is listed (2.1.1), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
