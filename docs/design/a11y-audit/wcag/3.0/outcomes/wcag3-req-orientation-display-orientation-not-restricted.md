---
id: "WCAG3-REQ-ORIENTATION"
title: "Display orientation not restricted"
...
# WCAG3-REQ-ORIENTATION — Display orientation not restricted

## Summary

Draft WCAG 3.0 requirement under guideline **Layout**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.3.4), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
