---
id: "WCAG3-REQ-REFLOW"
title: "Reflow without horizontal scroll"
...
# WCAG3-REQ-REFLOW — Reflow without horizontal scroll
...
- Where `mapsToWcag22` is listed (1.4.10), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
