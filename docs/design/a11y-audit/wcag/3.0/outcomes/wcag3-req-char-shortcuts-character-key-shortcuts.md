...
# WCAG3-REQ-CHAR-SHORTCUTS — Character key shortcuts

## Summary

Character key shortcuts — WCAG 3.0 draft (core). Guideline: Keyboard.


## Operator notes

Bronze/Silver/Gold tier requirement; maps to WCAG 2.2: 2.1.4.
...
- Where `mapsToWcag22` is listed (2.1.4), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
