...
# WCAG3-REQ-FOCUS-OBSCURED — Focus not obscured
...
- Where `mapsToWcag22` is listed (2.4.11), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
