---
id: "WCAG3-REQ-HOLISTIC-USABILITY"
title: "Holistic usability with disabled users"
conformanceTier: "supplemental"
wcagVersion: "3.0"
specUrl: "https://www.w3.org/TR/wcag-3.0/"
mapsToWcag22: ["2.4.5", "3.3.4"]
manualOnly: true
---
...
Holistic usability with disabled users — WCAG 3.0 draft (supplemental). Guideline: Process.


## Operator notes

Bronze/Silver/Gold tier requirement; maps to WCAG 2.2: 2.4.5, 3.3.4.
...
- Where `mapsToWcag22` is listed (2.4.5, 3.3.4), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
