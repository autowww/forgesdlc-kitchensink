---
id: "WCAG3-REQ-MEANINGFUL-SEQUENCE"
...
# WCAG3-REQ-MEANINGFUL-SEQUENCE — Meaningful sequence
...
- Where `mapsToWcag22` is listed (1.3.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
