---
id: "WCAG3-REQ-CAPTIONS"
title: "Captions for prerecorded audio"
...
Draft WCAG 3.0 requirement under guideline **Captions**. Tier: **core**. This is not a WCAG 2.x success criterion; conformance uses Bronze / Silver / Gold.
...
- Where `mapsToWcag22` is listed (1.2.2), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
