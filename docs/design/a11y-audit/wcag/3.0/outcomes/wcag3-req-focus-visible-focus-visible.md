...
# WCAG3-REQ-FOCUS-VISIBLE — Focus visible
...
- Where `mapsToWcag22` is listed (2.4.7), also verify mapped WCAG 2.2 success criteria for automation proxy coverage.
