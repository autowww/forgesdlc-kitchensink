...
wcagVersion: "2.0"
principle: 1
specUrl: "https://www.w3.org/TR/WCAG20/#images-of-text"
understandingUrl: "https://www.w3.org/WAI/WCAG20/Understanding/images-of-text"
forgeDetRules: ["DET.A11Y.GENERIC.IMAGES_OF_TEXT"]
forgeAiRules: []
manualOnly: false
---
...
Images of Text (Level AA) — Principle 1; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.IMAGES_OF_TEXT`


## Operator notes

Run axe with a profile that includes SC 1.4.5, then confirm DET/AI mappings below.
...
- Meet the success criterion as described in the W3C TR for **1.4.5**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.IMAGES_OF_TEXT |
| AI | — |
| Manual | Use axe + DET where mapped |

## Manual test steps

1. Identify pages or components in scope for **1.4.5**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG20/Understanding/images-of-text) techniques where applicable.
