...
wcagVersion: "2.0"
principle: 3
specUrl: "https://www.w3.org/TR/WCAG20/#on-input"
understandingUrl: "https://www.w3.org/WAI/WCAG20/Understanding/on-input"
forgeDetRules: ["DET.A11Y.GENERIC.INPUT_CONTEXT_CHANGE"]
forgeAiRules: []
manualOnly: false
---
...
On Input (Level A) — Principle 3; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.INPUT_CONTEXT_CHANGE`


## Operator notes

Run axe with a profile that includes SC 3.2.2, then confirm DET/AI mappings below.
...
- Meet the success criterion as described in the W3C TR for **3.2.2**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.INPUT_CONTEXT_CHANGE |
| AI | — |
| Manual | Use axe + DET where mapped |

## Manual test steps

1. Identify pages or components in scope for **3.2.2**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG20/Understanding/on-input) techniques where applicable.
