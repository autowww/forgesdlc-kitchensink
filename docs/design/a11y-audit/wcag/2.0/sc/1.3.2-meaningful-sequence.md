...
wcagVersion: "2.0"
principle: 1
specUrl: "https://www.w3.org/TR/WCAG20/#meaningful-sequence"
understandingUrl: "https://www.w3.org/WAI/WCAG20/Understanding/meaningful-sequence"
...
Meaningful Sequence (Level A) — Principle 1; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.READING_ORDER`


## Operator notes

Run axe with a profile that includes SC 1.3.2, then confirm DET/AI mappings below.
...
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG20/Understanding/meaningful-sequence) techniques where applicable.
