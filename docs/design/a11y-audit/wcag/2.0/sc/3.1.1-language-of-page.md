...
wcagVersion: "2.0"
principle: 3
specUrl: "https://www.w3.org/TR/WCAG20/#language-of-page"
understandingUrl: "https://www.w3.org/WAI/WCAG20/Understanding/language-of-page"
forgeDetRules: ["DET.A11Y.GENERIC.LANG"]
forgeAiRules: []
manualOnly: false
---
...
Language of Page (Level A) — Principle 3; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.LANG`


## Operator notes

Run axe with a profile that includes SC 3.1.1, then confirm DET/AI mappings below.
...
- Meet the success criterion as described in the W3C TR for **3.1.1**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.LANG |
| AI | — |
| Manual | Use axe + DET where mapped |

## Manual test steps

1. Identify pages or components in scope for **3.1.1**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG20/Understanding/language-of-page) techniques where applicable.
