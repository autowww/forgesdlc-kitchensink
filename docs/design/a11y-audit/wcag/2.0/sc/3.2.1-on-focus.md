...
wcagVersion: "2.0"
principle: 3
specUrl: "https://www.w3.org/TR/WCAG20/#on-focus"
understandingUrl: "https://www.w3.org/WAI/WCAG20/Understanding/on-focus"
...
On Focus (Level A) — Principle 3; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.FOCUS_CONTEXT_CHANGE`


## Operator notes

Run axe with a profile that includes SC 3.2.1, then confirm DET/AI mappings below.
...
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG20/Understanding/on-focus) techniques where applicable.
