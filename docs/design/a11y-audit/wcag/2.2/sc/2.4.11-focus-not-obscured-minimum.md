...
wcagVersion: "2.2"
principle: 2
specUrl: "https://www.w3.org/TR/WCAG22/#focus-not-obscured-minimum"
understandingUrl: "https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-minimum"
forgeDetRules: ["DET.A11Y.GENERIC.FOCUS_NOT_OBSCURED"]
forgeAiRules: []
manualOnly: false
---
...
Focus Not Obscured (Minimum) (WCAG 2.2 Level AA) ensures content remains perceivable, operable, understandable, or robust for people with disabilities. This page paraphrases the intent for Forge operators; see the normative [W3C specification](https://www.w3.org/TR/WCAG22/#focus-not-obscured-minimum) for legal text.
...
- Meet the success criterion as described in the W3C TR for **2.4.11**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.FOCUS_NOT_OBSCURED |
| AI | — |
| Manual | Use axe + DET where mapped |

## Manual test steps

1. Identify pages or components in scope for **2.4.11**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-minimum) techniques where applicable.
