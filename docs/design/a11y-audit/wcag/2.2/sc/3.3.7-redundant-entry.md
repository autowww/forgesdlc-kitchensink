...
wcagVersion: "2.2"
principle: 3
specUrl: "https://www.w3.org/TR/WCAG22/#redundant-entry"
understandingUrl: "https://www.w3.org/WAI/WCAG22/Understanding/redundant-entry"
forgeDetRules: ["DET.A11Y.GENERIC.REDUNDANT_ENTRY"]
forgeAiRules: []
manualOnly: true
---
...
Redundant Entry (WCAG 2.2 Level AA) ensures content remains perceivable, operable, understandable, or robust for people with disabilities. This page paraphrases the intent for Forge operators; see the normative [W3C specification](https://www.w3.org/TR/WCAG22/#redundant-entry) for legal text.
...
- Meet the success criterion as described in the W3C TR for **3.3.7**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.REDUNDANT_ENTRY |
| AI | — |
| Manual | Expected — run manual test steps below |

## Manual test steps

1. Identify pages or components in scope for **3.3.7**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG22/Understanding/redundant-entry) techniques where applicable.
