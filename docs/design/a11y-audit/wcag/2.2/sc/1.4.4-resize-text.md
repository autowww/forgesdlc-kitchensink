...
Resize Text (WCAG 2.2 Level AA) ensures content remains perceivable, operable, understandable, or robust for people with disabilities. This page paraphrases the intent for Forge operators; see the normative [W3C specification](https://www.w3.org/TR/WCAG22/#resize-text) for legal text.
