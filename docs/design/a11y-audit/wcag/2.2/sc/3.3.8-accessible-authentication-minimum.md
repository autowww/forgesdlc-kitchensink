...
wcagVersion: "2.2"
principle: 3
specUrl: "https://www.w3.org/TR/WCAG22/#accessible-authentication-minimum"
understandingUrl: "https://www.w3.org/WAI/WCAG22/Understanding/accessible-authentication-minimum"
forgeDetRules: ["DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION"]
forgeAiRules: []
manualOnly: true
---
...
Accessible Authentication (Minimum) (WCAG 2.2 Level AA) ensures content remains perceivable, operable, understandable, or robust for people with disabilities. This page paraphrases the intent for Forge operators; see the normative [W3C specification](https://www.w3.org/TR/WCAG22/#accessible-authentication-minimum) for legal text.
...
- Meet the success criterion as described in the W3C TR for **3.3.8**.
...
| Lane | Rules |
|------|-------|
| DET | DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION |
| AI | — |
| Manual | Expected — run manual test steps below |

## Manual test steps

1. Identify pages or components in scope for **3.3.8**.
2. Exercise primary user tasks with keyboard only and with at least one screen reader.
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG22/Understanding/accessible-authentication-minimum) techniques where applicable.
