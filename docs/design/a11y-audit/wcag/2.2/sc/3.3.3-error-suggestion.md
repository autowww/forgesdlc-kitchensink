...
wcagVersion: "2.2"
principle: 3
specUrl: "https://www.w3.org/TR/WCAG22/#error-suggestion"
understandingUrl: "https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion"
forgeDetRules: []
...
Error Suggestion (Level AA) — Principle 3; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.
...
Run axe with a profile that includes SC 3.3.3, then confirm DET/AI mappings below.
...
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion) techniques where applicable.
