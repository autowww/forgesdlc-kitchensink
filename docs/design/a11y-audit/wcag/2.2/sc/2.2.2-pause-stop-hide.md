...
wcagVersion: "2.2"
principle: 2
specUrl: "https://www.w3.org/TR/WCAG22/#pause-stop-hide"
understandingUrl: "https://www.w3.org/WAI/WCAG22/Understanding/pause-stop-hide"
...
Pause, Stop, Hide (Level A) — Principle 2; verify perceivable, operable, understandable, and robust outcomes for users with disabilities. See the normative W3C TR for legal wording.

**Highlighted Forge rules:** `DET.A11Y.GENERIC.PAUSE_STOP_HIDE`


## Operator notes

Run axe with a profile that includes SC 2.2.2, then confirm DET/AI mappings below.
...
3. Compare results against the W3C [Understanding](https://www.w3.org/WAI/WCAG22/Understanding/pause-stop-hide) techniques where applicable.
