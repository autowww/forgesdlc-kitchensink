...
generatedAt: 2026-05-28T08:42:55.310Z
---
...
Standards pack: [`tools/website-a11y-auditor/design-rules/standards-packs/wcag22aaa.pack.json`](../../../../tools/website-a11y-auditor/design-rules/standards-packs/wcag22aaa.pack.json)
...
| **1.3.1** | Info and Relationships | axe+det+manual_ai | covered | 12 | `DET.A11Y.GENERIC.LANDMARKS` (patch_landmarks), `DET.A11Y.GENERIC.DATA_TABLE_HEADERS` (patch_data_table) | `AI.A11Y.KS.REGION_LABELING` (ai_apply_region_labeling) | [md](../../wcag/2.2/sc/1.3.1-info-and-relationships.md) |
...
| **2.2.1** | Timing Adjustable | axe+det+manual_ai | manual_expected | 1 | `DET.A11Y.GENERIC.TIMING` (patch_motion_reduced) | `AI.A11Y.GENERIC.TIMING_ADJUSTABLE` (ai_apply_timing_adjustable) | [md](../../wcag/2.2/sc/2.2.1-timing-adjustable.md) |
...
| **2.2.3** | No Timing | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.TIMING` (patch_motion_reduced) | `AI.A11Y.GENERIC.TIMING_ADJUSTABLE` (ai_apply_timing_adjustable) | — |
...
| **2.2.5** | Re-authenticating | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.RE_AUTHENTICATION` (patch_re_authentication) | `AI.A11Y.GENERIC.RE_AUTHENTICATION` (plan_only) | — |
...
| **2.4.9** | Link Purpose (Link Only) | det | covered | — | `DET.A11Y.GENERIC.LINK_PURPOSE` (patch_cta_label) | — | — |
...
| **2.4.12** | Focus Not Obscured (Enhanced) | det | manual_expected | — | `DET.A11Y.GENERIC.FOCUS_OBSCURED_ENHANCED` (patch_ambient_z) | — | — |
| **2.4.13** | Focus Appearance | det | manual_expected | — | `DET.A11Y.GENERIC.FOCUS_APPEARANCE` (patch_page_mode) | — | — |
...
| **2.5.6** | Concurrent Input Mechanisms | det | covered | — | `DET.A11Y.GENERIC.CONCURRENT_INPUT` (patch_concurrent_input) | — | — |
...
| **3.1.3** | Unusual Words | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.GLOSSARY_ABBR` (patch_glossary_abbr) | `AI.A11Y.GENERIC.UNUSUAL_WORDS` (plan_only) | — |
| **3.1.4** | Abbreviations | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.GLOSSARY_ABBR` (patch_glossary_abbr) | `AI.A11Y.GENERIC.UNUSUAL_WORDS` (plan_only) | — |
| **3.1.5** | Reading Level | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.READING_LEVEL_HEURISTIC` (patch_reading_level) | `AI.A11Y.GENERIC.READING_LEVEL` (ai_apply_reading_level) | — |
| **3.1.6** | Pronunciation | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.GLOSSARY_ABBR` (patch_glossary_abbr) | `AI.A11Y.GENERIC.PRONUNCIATION` (plan_only) | — |
...
| **3.3.4** | Error Prevention (Legal, Financial, Data) | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.ERROR_PREVENTION` (patch_error_prevention) | `AI.A11Y.GENERIC.ERROR_PREVENTION` (ai_apply_error_prevention) | [md](../../wcag/2.2/sc/3.3.4-error-prevention-legal-financial-data.md) |
...
| **3.3.6** | Error Prevention (All) | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.ERROR_PREVENTION` (patch_error_prevention) | `AI.A11Y.GENERIC.ERROR_PREVENTION` (ai_apply_error_prevention) | — |
...
| **3.3.9** | Accessible Authentication (Enhanced) | det | manual_expected | — | `DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION` (patch_accessible_auth) | — | — |
| **4.1.1** | Parsing | manual_catalog | manual_expected | — | — | — | [md](../../wcag/2.2/sc/4.1.1-parsing.md) |
| **4.1.2** | Name, Role, Value | axe+det+manual_ai | covered | 28 | `DET.A11Y.KS.HASH_MARKERS` (hash_markers), `DET.A11Y.KS.REACT_A11Y_ROLE` (patch_landmarks), `DET.A11Y.KS.PY_HASH_ATTRS` (repo_production) | `AI.A11Y.KS.HANDBOOK_SIDEBAR_LABELS` (remediation_note), `AI.A11Y.KS.REGION_LABELING` (ai_apply_region_labeling) | [md](../../wcag/2.2/sc/4.1.2-name-role-value.md) |
