...
wcagVersion: ""
level: ""
packJson: tools/website-a11y-auditor/design-rules/standards-packs/wcag20a.pack.json
...
Standards pack: [`tools/website-a11y-auditor/design-rules/standards-packs/wcag20a.pack.json`](../../../../tools/website-a11y-auditor/design-rules/standards-packs/wcag20a.pack.json)
...
|--------|------:|
| Total criteria | 26 |
| Covered (axe and/or DET/AI) | 18 |
| Manual expected | 8 |
| Uncovered | 0 |
| Untied Forge rules | 0 |
| Axe rules in profile | 61 |
