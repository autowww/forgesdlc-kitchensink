...
wcagVersion: ""
level: ""
packJson: tools/website-a11y-auditor/design-rules/standards-packs/wcag21aaa.pack.json
generatedAt: 2026-05-28T08:42:55.309Z
---
...
Standards pack: [`tools/website-a11y-auditor/design-rules/standards-packs/wcag21aaa.pack.json`](../../../../tools/website-a11y-auditor/design-rules/standards-packs/wcag21aaa.pack.json)
...
|--------|------:|
| Total criteria | 74 |
| Covered (axe and/or DET/AI) | 43 |
| Manual expected | 31 |
| Uncovered | 0 |
| Untied Forge rules | 0 |
| Axe rules in profile | 71 |
...
| **2.2.4** | Interruptions | axe+det+manual_ai | manual_expected | 1 | `DET.A11Y.GENERIC.INTERRUPTIONS` (patch_motion_reduced) | `AI.A11Y.GENERIC.INTERRUPTIONS` (plan_only) | — |
...
| **3.2.5** | Change on Request | axe+det+manual_ai | manual_expected | 1 | `DET.A11Y.GENERIC.CHANGE_ON_REQUEST` (patch_motion_reduced) | `AI.A11Y.GENERIC.CHANGE_ON_REQUEST` (plan_only) | — |
