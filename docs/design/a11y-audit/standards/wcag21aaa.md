...
| **2.2.4** | Interruptions | axe+det+manual_ai | manual_expected | 1 | `DET.A11Y.GENERIC.INTERRUPTIONS` (patch_motion_reduced) | `AI.A11Y.GENERIC.INTERRUPTIONS` (remediation_note) | — |
...
| **3.2.5** | Change on Request | axe+det+manual_ai | manual_expected | 1 | `DET.A11Y.GENERIC.CHANGE_ON_REQUEST` (patch_motion_reduced) | `AI.A11Y.GENERIC.CHANGE_ON_REQUEST` (remediation_note) | — |
