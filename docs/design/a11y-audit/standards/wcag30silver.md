...
generatedAt: 2026-05-28T08:42:55.312Z
---
...
| **WCAG3-REQ-HOLISTIC-USABILITY** | Holistic usability with disabled users | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.MULTIPLE_WAYS` (patch_nav_toc), `DET.A11Y.GENERIC.ERROR_PREVENTION` (patch_error_prevention) | `AI.A11Y.GENERIC.MULTIPLE_WAYS` (plan_only), `AI.A11Y.GENERIC.ERROR_PREVENTION` (ai_apply_error_prevention) | [md](../../wcag/3.0/outcomes/wcag3-req-holistic-usability-holistic-usability-with-disabled-users.md) |
| **WCAG3-REQ-INFO-STRUCTURE** | Information and structure programmatically avail | axe+det+manual_ai | covered | 12 | `DET.A11Y.GENERIC.LANDMARKS` (patch_landmarks), `DET.A11Y.GENERIC.DATA_TABLE_HEADERS` (patch_data_table) | `AI.A11Y.KS.REGION_LABELING` (ai_apply_region_labeling) | [md](../../wcag/3.0/outcomes/wcag3-req-info-structure-information-and-structure-programmatically-available.md) |
...
| **WCAG3-REQ-NAME-ROLE-VALUE** | Name, role, value | axe+det+manual_ai | covered | 28 | `DET.A11Y.KS.HASH_MARKERS` (hash_markers), `DET.A11Y.KS.REACT_A11Y_ROLE` (patch_landmarks), `DET.A11Y.KS.PY_HASH_ATTRS` (repo_production) | `AI.A11Y.KS.HANDBOOK_SIDEBAR_LABELS` (remediation_note), `AI.A11Y.KS.REGION_LABELING` (ai_apply_region_labeling) | [md](../../wcag/3.0/outcomes/wcag3-req-name-role-value-name-role-value.md) |
...
| **WCAG3-REQ-ORG-PRACTICES** | Organizational accessibility practices | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.ERROR_PREVENTION` (patch_error_prevention) | `AI.A11Y.GENERIC.ERROR_PREVENTION` (ai_apply_error_prevention) | [md](../../wcag/3.0/outcomes/wcag3-req-org-practices-organizational-accessibility-practices.md) |
...
| **WCAG3-REQ-READING-LEVEL** | Reading level / plain language | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.READING_LEVEL_HEURISTIC` (patch_reading_level) | `AI.A11Y.GENERIC.READING_LEVEL` (ai_apply_reading_level) | [md](../../wcag/3.0/outcomes/wcag3-req-reading-level-reading-level-plain-language.md) |
...
| **WCAG3-REQ-TIMING** | Timing adjustable | axe+det+manual_ai | manual_expected | 1 | `DET.A11Y.GENERIC.TIMING` (patch_motion_reduced) | `AI.A11Y.GENERIC.TIMING_ADJUSTABLE` (ai_apply_timing_adjustable) | [md](../../wcag/3.0/outcomes/wcag3-req-timing-timing-adjustable.md) |
