---
profileId: wcag30silver
label: "WCAG 3.0 silver"
wcagVersion: "3.0"
level: "silver"
packJson: tools/website-a11y-auditor/design-rules/standards-packs/wcag30silver.pack.json
generatedAt: 2026-05-28T08:29:08.569Z
---
...
Standards pack: [`tools/website-a11y-auditor/design-rules/standards-packs/wcag30silver.pack.json`](../../../../tools/website-a11y-auditor/design-rules/standards-packs/wcag30silver.pack.json)
...
| **WCAG3-REQ-AUTH-ENH** | Accessible authentication (enhanced) | det | manual_expected | — | `DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION` (patch_accessible_auth) | — | [md](../../wcag/3.0/outcomes/wcag3-req-auth-enh-accessible-authentication-enhanced.md) |
| **WCAG3-REQ-AUTH-MIN** | Accessible authentication (minimum) | det | manual_expected | — | `DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION` (patch_accessible_auth) | — | [md](../../wcag/3.0/outcomes/wcag3-req-auth-min-accessible-authentication-minimum.md) |
...
| **WCAG3-REQ-CHAR-SHORTCUTS** | Character key shortcuts | det | covered | — | `DET.A11Y.GENERIC.CHARACTER_SHORTCUTS` (patch_page_mode) | — | [md](../../wcag/3.0/outcomes/wcag3-req-char-shortcuts-character-key-shortcuts.md) |
| **WCAG3-REQ-CONSISTENT-HELP** | Consistent help | det | manual_expected | — | `DET.A11Y.GENERIC.CONSISTENT_HELP` (patch_nav_toc) | — | [md](../../wcag/3.0/outcomes/wcag3-req-consistent-help-consistent-help.md) |
| **WCAG3-REQ-CONTEXT-HELP** | Context-sensitive help | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.CONTEXT_HELP` (patch_nav_toc) | `AI.A11Y.GENERIC.CONTEXT_HELP` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-context-help-context-sensitive-help.md) |
...
| **WCAG3-REQ-DRAGGING** | Dragging movements | det | manual_expected | — | `DET.A11Y.GENERIC.DRAGGING_MOVEMENTS` (patch_dragging_movements) | — | [md](../../wcag/3.0/outcomes/wcag3-req-dragging-dragging-movements.md) |
| **WCAG3-REQ-ENHANCED-CONTRAST** | Enhanced text contrast | det | covered | — | `DET.A11Y.GENERIC.CONTRAST_ENHANCED` (patch_page_mode) | — | [md](../../wcag/3.0/outcomes/wcag3-req-enhanced-contrast-enhanced-text-contrast.md) |
| **WCAG3-REQ-ERROR-ID** | Error identification | manual_ai | covered | — | — | `AI.A11Y.GENERIC.FORM_ERROR_ASSOCIATION` (ai_apply_form_error) | [md](../../wcag/3.0/outcomes/wcag3-req-error-id-error-identification.md) |
| **WCAG3-REQ-ERROR-SUGGEST** | Error suggestions | manual_ai | covered | — | — | `AI.A11Y.GENERIC.FORM_ERROR_ASSOCIATION` (ai_apply_form_error) | [md](../../wcag/3.0/outcomes/wcag3-req-error-suggest-error-suggestions.md) |
| **WCAG3-REQ-FOCUS-APPEARANCE** | Focus appearance | det | covered | — | `DET.A11Y.GENERIC.FOCUS_APPEARANCE` (patch_page_mode) | — | [md](../../wcag/3.0/outcomes/wcag3-req-focus-appearance-focus-appearance.md) |
...
| **WCAG3-REQ-FOCUS-OBSCURED-ENH** | Focus not obscured (enhanced) | det | covered | — | `DET.A11Y.GENERIC.FOCUS_OBSCURED_ENHANCED` (patch_ambient_z) | — | [md](../../wcag/3.0/outcomes/wcag3-req-focus-obscured-enh-focus-not-obscured-enhanced.md) |
| **WCAG3-REQ-FOCUS-ORDER** | Focus order | det+manual_ai | covered | — | `DET.A11Y.GENERIC.FOCUS_ORDER` (patch_landmarks), `DET.A11Y.GENERIC.APP_FOCUS_TRAP` (patch_app_focus_trap) | `AI.A11Y.GENERIC.KEYBOARD_TASK_FLOW` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-focus-order-focus-order.md) |
| **WCAG3-REQ-FOCUS-VISIBLE** | Focus visible | manual_ai | covered | — | — | `AI.A11Y.GENERIC.KEYBOARD_TASK_FLOW` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-focus-visible-focus-visible.md) |
...
| **WCAG3-REQ-HOLISTIC-USABILITY** | Holistic usability with disabled users | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.MULTIPLE_WAYS` (patch_nav_toc), `DET.A11Y.GENERIC.ERROR_PREVENTION` (patch_error_prevention) | `AI.A11Y.GENERIC.MULTIPLE_WAYS` (remediation_note), `AI.A11Y.GENERIC.ERROR_PREVENTION` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-holistic-usability-holistic-usability-with-disabled-users.md) |
...
| **WCAG3-REQ-KEYWORD** | Keyboard operable | axe+det+manual_ai | covered | 3 | `DET.A11Y.GENERIC.KEYBOARD_ACCESS` (patch_landmarks) | `AI.A11Y.GENERIC.KEYBOARD_TASK_FLOW` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-keyword-keyboard-operable.md) |
...
| **WCAG3-REQ-LANG-PARTS** | Language of parts | axe+det | covered | 1 | `DET.A11Y.GENERIC.LANG_OF_PARTS` (patch_page_lang) | — | [md](../../wcag/3.0/outcomes/wcag3-req-lang-parts-language-of-parts.md) |
...
| **WCAG3-REQ-NO-KB-TRAP** | No keyboard trap | det+manual_ai | covered | — | `DET.A11Y.GENERIC.APP_FOCUS_TRAP` (patch_app_focus_trap) | `AI.A11Y.GENERIC.KEYBOARD_TASK_FLOW` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-no-kb-trap-no-keyboard-trap.md) |
...
| **WCAG3-REQ-ORG-PRACTICES** | Organizational accessibility practices | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.ERROR_PREVENTION` (patch_error_prevention) | `AI.A11Y.GENERIC.ERROR_PREVENTION` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-org-practices-organizational-accessibility-practices.md) |
...
| **WCAG3-REQ-PAUSE** | Pause, stop, hide moving content | axe+det | covered | 2 | `DET.A11Y.GENERIC.PAUSE_STOP_HIDE` (patch_motion_flash) | — | [md](../../wcag/3.0/outcomes/wcag3-req-pause-pause-stop-hide-moving-content.md) |
...
| **WCAG3-REQ-READING-LEVEL** | Reading level / plain language | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.READING_LEVEL_HEURISTIC` (patch_reading_level) | `AI.A11Y.GENERIC.READING_LEVEL` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-reading-level-reading-level-plain-language.md) |
| **WCAG3-REQ-REDUNDANT-ENTRY** | Redundant entry avoided | det | manual_expected | — | `DET.A11Y.GENERIC.REDUNDANT_ENTRY` (patch_redundant_entry) | — | [md](../../wcag/3.0/outcomes/wcag3-req-redundant-entry-redundant-entry-avoided.md) |
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-ad-audio-description-or-media-alternative.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-auth-enh-accessible-authentication-enhanced.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-auth-min-accessible-authentication-minimum.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-captions-captions-for-prerecorded-audio.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-consistent-help-consistent-help.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-context-help-context-sensitive-help.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-dragging-dragging-movements.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-holistic-usability-holistic-usability-with-disabled-users.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-org-practices-organizational-accessibility-practices.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-pointer-gestures-pointer-gestures-have-single-pointer-alternative.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-reading-level-reading-level-plain-language.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-redundant-entry-redundant-entry-avoided.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-sensory-instructions-not-sensory-only.md)
...
Reference: [WCAG reference](../../wcag/3.0/outcomes/wcag3-req-timing-timing-adjustable.md)
