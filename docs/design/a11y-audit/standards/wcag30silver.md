...
| **WCAG3-REQ-CONTEXT-HELP** | Context-sensitive help | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.CONTEXT_HELP` (handbook_after) | `AI.A11Y.GENERIC.CONTEXT_HELP` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-context-help-context-sensitive-help.md) |
