...
generatedAt: 2026-05-28T06:59:02.986Z
---
...
| **WCAG3-REQ-AUTH-ENH** | Accessible authentication (enhanced) | det | manual_expected | — | `DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION` (handbook_after) | — | [md](../../wcag/3.0/outcomes/wcag3-req-auth-enh-accessible-authentication-enhanced.md) |
| **WCAG3-REQ-AUTH-MIN** | Accessible authentication (minimum) | det | manual_expected | — | `DET.A11Y.GENERIC.ACCESSIBLE_AUTHENTICATION` (handbook_after) | — | [md](../../wcag/3.0/outcomes/wcag3-req-auth-min-accessible-authentication-minimum.md) |
...
| **WCAG3-REQ-DRAGGING** | Dragging movements | det | manual_expected | — | `DET.A11Y.GENERIC.DRAGGING_MOVEMENTS` (handbook_after) | — | [md](../../wcag/3.0/outcomes/wcag3-req-dragging-dragging-movements.md) |
...
| **WCAG3-REQ-ORG-PRACTICES** | Organizational accessibility practices | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.ERROR_PREVENTION` (handbook_after) | `AI.A11Y.GENERIC.ERROR_PREVENTION` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-org-practices-organizational-accessibility-practices.md) |
...
| **WCAG3-REQ-READING-LEVEL** | Reading level / plain language | det+manual_ai | manual_expected | — | `DET.A11Y.GENERIC.READING_LEVEL_HEURISTIC` (handbook_after) | `AI.A11Y.GENERIC.READING_LEVEL` (remediation_note) | [md](../../wcag/3.0/outcomes/wcag3-req-reading-level-reading-level-plain-language.md) |
| **WCAG3-REQ-REDUNDANT-ENTRY** | Redundant entry avoided | det | manual_expected | — | `DET.A11Y.GENERIC.REDUNDANT_ENTRY` (handbook_after) | — | [md](../../wcag/3.0/outcomes/wcag3-req-redundant-entry-redundant-entry-avoided.md) |
