...
- https://ks.forgesdlc.com/showcase/preview-split.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Spl.png

## Acceptance checklist

- [ ] Root emits `hash="Spl"` and matching `data-ks-hash`.
