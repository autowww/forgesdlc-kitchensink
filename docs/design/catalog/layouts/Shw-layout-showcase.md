---
hash: "Shw"
name: "Showcase documentation layout"
type: "layout"
status: "active"
source_paths:
  - components/layouts.py
showcase_url: null
screenshot_url: "https://ks.forgesdlc.com/showcase/screenshots/Shw.png"
screenshot_status: "planned"
---

# Shw — Showcase documentation layout
...
- **Screenshot URL / status:** https://ks.forgesdlc.com/showcase/screenshots/Shw.png — status **planned**

## Purpose

Internal KS documentation and gallery frame—curated nav, breadcrumbs on select pages, space for dense component lists and references.
...
Showcase nav chrome; optional breadcrumb; wide `main` for grids and samples; typical footer.
...
Python `showcase_page` in `components/layouts.py`; most `generator/pages/*.py` museum pages use this shell.
