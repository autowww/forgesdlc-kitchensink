...
- https://ks.forgesdlc.com/showcase/preview-product.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Prd.png

## Acceptance checklist

- [ ] Root emits `hash="Prd"` and matching `data-ks-hash`.
