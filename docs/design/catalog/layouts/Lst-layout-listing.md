...
showcase_url: "https://ks.forgesdlc.com/showcase/preview-listing.html"
screenshot_url: "https://ks.forgesdlc.com/showcase/screenshots/Lst.png"
...
- **Showcase URL / status:** https://ks.forgesdlc.com/showcase/preview-listing.html (active preview page)
- **Screenshot URL / status:** https://ks.forgesdlc.com/showcase/screenshots/Lst.png — status **planned**

## Purpose

Resource hub or filtered index: list rows, cards, pagination, and empty-state affordances.
...
Intro block; optional filters; primary list container; pagination or load-more controls.
...
Python `listing_page` in `components/layouts.py`; pair with listing renderers from `Kpr` where used.
