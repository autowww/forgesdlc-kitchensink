...
showcase_url: "https://ks.forgesdlc.com/cases/showcase/preview-split.html"
screenshot_url: "https://ks.forgesdlc.com/cases/showcase/screenshots/Vsp.png"
...
- **Showcase URL / status:** https://ks.forgesdlc.com/cases/showcase/preview-split.html (active preview page)
- **Screenshot URL / status:** https://ks.forgesdlc.com/cases/showcase/screenshots/Vsp.png — status **planned**

## Purpose

Static preview page demonstrating **Preview split layout** in isolation (`generator/layout_previews.py`, symbol `write_layout_preview_pages`) for visual QA and hash marker checks.
