...
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Vsp.png

## Acceptance checklist

- [ ] Root emits `hash="Vsp"` and matching `data-ks-hash`.
