...
type: "page"
status: "active"
source_paths: ["generator/pages/tokens.py"]
...
- https://ks.forgesdlc.com/showcase/tokens.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Tkn.png

## Acceptance checklist

- [ ] Root emits `hash="Tkn"` and matching `data-ks-hash`.
