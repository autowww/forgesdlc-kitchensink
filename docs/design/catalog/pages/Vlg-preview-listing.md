...
- https://ks.forgesdlc.com/showcase/preview-listing.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Vlg.png

## Acceptance checklist

- [ ] Root emits `hash="Vlg"` and matching `data-ks-hash`.
