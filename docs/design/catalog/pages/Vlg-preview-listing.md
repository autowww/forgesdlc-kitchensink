...
showcase_url: "https://ks.forgesdlc.com/cases/showcase/preview-listing.html"
screenshot_url: "https://ks.forgesdlc.com/cases/showcase/screenshots/Vlg.png"
...
- **Showcase URL / status:** https://ks.forgesdlc.com/cases/showcase/preview-listing.html (active preview page)
- **Screenshot URL / status:** https://ks.forgesdlc.com/cases/showcase/screenshots/Vlg.png — status **planned**

## Purpose

Static preview page demonstrating **Preview listing layout** in isolation (`generator/layout_previews.py`, symbol `write_layout_preview_pages`) for visual QA and hash marker checks.

## Expected look

- Static **preview** of **Lst** listing layout—grid/table density visible at neutral desktop width.
- Validates spacing against crowded indexes ([forge-enterprise-ai-website-standard.md](../../../design/forge-enterprise-ai-website-standard.md)).
...
- Showcase/build output honors **Vlg** markers: emitted roots include both `hash="Vlg"` and `data-ks-hash="Vlg"` where `emit_marker_in_showcase` / museum rules apply.
...
- Does the preview communicate *which* layout family is selected (visual signature of **Preview listing layout**) to handbook readers at a glance?
