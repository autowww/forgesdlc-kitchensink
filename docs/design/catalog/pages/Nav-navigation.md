...
type: "page"
status: "active"
source_paths: ["generator/pages/navigation.py"]
...
- https://ks.forgesdlc.com/showcase/navigation.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Nav.png

## Acceptance checklist

- [ ] Root emits `hash="Nav"` and matching `data-ks-hash`.
