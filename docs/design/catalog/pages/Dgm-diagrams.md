...
type: "page"
status: "active"
source_paths: ["generator/pages/diagrams.py"]
...
- https://ks.forgesdlc.com/showcase/diagrams.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Dgm.png

## Acceptance checklist

- [ ] Root emits `hash="Dgm"` and matching `data-ks-hash`.
