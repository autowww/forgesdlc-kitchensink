...
type: "page"
status: "active"
source_paths: ["generator/pages/ks_creation_mindmap.py"]
...
- https://ks.forgesdlc.com/showcase/ks-creation-mindmap.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Kcm.png

## Acceptance checklist

- [ ] Root emits `hash="Kcm"` and matching `data-ks-hash`.
