...
- https://ks.forgesdlc.com/showcase/preview-handbook.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Vhb.png

## Acceptance checklist

- [ ] Root emits `hash="Vhb"` and matching `data-ks-hash`.
