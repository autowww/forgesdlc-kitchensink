...
type: "page"
status: "active"
source_paths: ["generator/pages/enterprise_marketing.py"]
...
- https://ks.forgesdlc.com/showcase/enterprise-marketing.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Enm.png

## Acceptance checklist

- [ ] Root emits `hash="Enm"` and matching `data-ks-hash`.
