...
- https://ks.forgesdlc.com/showcase/preview-chapter.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Vcp.png

## Acceptance checklist

- [ ] Root emits `hash="Vcp"` and matching `data-ks-hash`.
