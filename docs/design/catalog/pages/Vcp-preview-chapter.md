...
showcase_url: "https://ks.forgesdlc.com/cases/showcase/preview-chapter.html"
screenshot_url: "https://ks.forgesdlc.com/cases/showcase/screenshots/Vcp.png"
...
- **Showcase URL / status:** https://ks.forgesdlc.com/cases/showcase/preview-chapter.html (active preview page)
- **Screenshot URL / status:** https://ks.forgesdlc.com/cases/showcase/screenshots/Vcp.png — status **planned**

## Purpose

Static preview page demonstrating **Preview chapter layout** in isolation (`generator/layout_previews.py`, symbol `write_layout_preview_pages`) for visual QA and hash marker checks.

## Expected look

- Static **preview** of **Chp** chapter layout for golden screenshots—reading column and rails visible at desktop width.
- No interactive authoring UI—pure catalog capture surface ([forge-enterprise-ai-website-standard.md](../../../design/forge-enterprise-ai-website-standard.md)).
...
- Showcase/build output honors **Vcp** markers: emitted roots include both `hash="Vcp"` and `data-ks-hash="Vcp"` where `emit_marker_in_showcase` / museum rules apply.
...
- Does the preview communicate *which* layout family is selected (visual signature of **Preview chapter layout**) to handbook readers at a glance?
