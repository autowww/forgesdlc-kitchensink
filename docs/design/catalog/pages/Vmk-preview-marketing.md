...
- https://ks.forgesdlc.com/showcase/preview-marketing.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Vmk.png

## Acceptance checklist

- [ ] Root emits `hash="Vmk"` and matching `data-ks-hash`.
