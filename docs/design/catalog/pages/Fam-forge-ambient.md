...
type: "page"
status: "active"
source_paths: ["generator/pages/forge_ambient.py"]
...
- https://ks.forgesdlc.com/showcase/forge-ambient.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Fam.png

## Acceptance checklist

- [ ] Root emits `hash="Fam"` and matching `data-ks-hash`.
