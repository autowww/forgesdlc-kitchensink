...
- https://ks.forgesdlc.com/showcase/preview-landing.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Vln.png

## Acceptance checklist

- [ ] Root emits `hash="Vln"` and matching `data-ks-hash`.
