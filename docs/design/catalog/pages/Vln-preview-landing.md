...
showcase_url: "https://ks.forgesdlc.com/cases/showcase/preview-landing.html"
screenshot_url: "https://ks.forgesdlc.com/cases/showcase/screenshots/Vln.png"
...
- **Showcase URL / status:** https://ks.forgesdlc.com/cases/showcase/preview-landing.html (active preview page)
- **Screenshot URL / status:** https://ks.forgesdlc.com/cases/showcase/screenshots/Vln.png — status **planned**

## Purpose

Static preview page demonstrating **Preview landing layout** in isolation (`generator/layout_previews.py`, symbol `write_layout_preview_pages`) for visual QA and hash marker checks.

## Expected look

- Static **preview** of **Ldg** landing layout—hero band and first folds composed for screenshot parity.
- Ensures landing chrome does not collide with museum chrome ([forge-enterprise-ai-website-standard.md](../../../design/forge-enterprise-ai-website-standard.md)).
...
- Showcase/build output honors **Vln** markers: emitted roots include both `hash="Vln"` and `data-ks-hash="Vln"` where `emit_marker_in_showcase` / museum rules apply.
...
- Does the preview communicate *which* layout family is selected (visual signature of **Preview landing layout**) to handbook readers at a glance?
