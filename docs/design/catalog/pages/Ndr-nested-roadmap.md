...
type: "page"
status: "active"
source_paths: ["generator/pages/nested_roadmap.py"]
...
- https://ks.forgesdlc.com/showcase/nested-roadmap.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Ndr.png

## Acceptance checklist

- [ ] Root emits `hash="Ndr"` and matching `data-ks-hash`.
