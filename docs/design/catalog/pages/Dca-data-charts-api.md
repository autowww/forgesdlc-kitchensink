...
type: "page"
status: "active"
source_paths: ["generator/pages/data_charts_api.py"]
...
- https://ks.forgesdlc.com/showcase/data-charts-api.html
- Screenshot: https://ks.forgesdlc.com/showcase/screenshots/Dca.png

## Acceptance checklist

- [ ] Root emits `hash="Dca"` and matching `data-ks-hash`.
